...
description: Erfahren Sie, wie Sie Adobe [!DNL Target] in die Adobe Dynamic Media Classic (früher Scene7) integrieren, um Digital Asset Management (DAM) in der Inhaltsbibliothek bereitzustellen.
