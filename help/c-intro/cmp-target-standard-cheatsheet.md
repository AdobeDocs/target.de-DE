...
Weitere Informationen zur neuesten Version finden Sie in den [Versionshinweisen](../r-release-notes/release-notes.md#reference_8FE40B43A5A34DDF8F26A53D55EE036A). Informationen über alle unsere [bisherigen Versionen](../r-release-notes/release-notes-for-previous-releases.md) sind ebenfalls online verfügbar.
...
Für die besten Ergebnisse verwenden Sie [die A/B-Tests](../c-activities/t-test-ab/test-ab.md#task_05E33EB15C4D4459B5EAFF90A94A7977) (Option „Manuelles Targeting“) zusammen mit [dem Stichprobengrößenrechner](../c-activities/t-test-ab/sample-size-determination.md#section_286EB6E671184239BB1552F0387DAEB5).

**Woran erkenne ich, wann ich meine Aktivität stoppen muss?**

Das verfrühte Stoppen von Aktivitäten kann zu falschen Schlüssen führen. Beachten Sie [allgemeine Fallen und vermeiden Sie sie mittels eingehaltener Verfahren](../c-activities/t-test-ab/common-ab-testing-pitfalls.md#section_DF01A97275E44CA5859D825E0DE2F49F). Siehe [Wie lange sollten A/B-Tests laufen](/help/c-activities/t-test-ab/sample-size-determination.md)?
...
Verwenden Sie unsere [Berichte zur Ermittlung des erfolgreichsten Erlebnisses](../c-activities/automated-traffic-allocation/determine-winner.md#concept_5741A89ED7224E1285A3BC34B2CCD0F9).

**Kann ich eine Aktivität mit einer Personalisierungsebene als einen integralen Bestandteil der Aktivität durchführen?**

Sehen Sie sich auch die [A/B-Tests mit Automatisches Targeting](../c-activities/auto-target-to-optimize.md#concept_67779E5B7F67427A97D7EA2A6FB919B3)-Option an.

**Woran erkenne ich, welcher Aktivitätstyp sich am besten für meine Anforderungen eignet?**

Lesen Sie das [Target Activities-Handbuch](../c-activities/target-activities-guide.md#concept_D974B0918EB74B3B8CB07ACD32BF37A1), um die Szenarien zu verstehen, in der die einzelnen von Adobe Target bereitgestellten Optionen jeweils sinnvoll sind.

Denken Sie auch an die [Empfehlungs-Aktivitäten](../c-recommendations/recommendations.md#concept_7556C8A4543942F2A77B13A29339C0C0).
...
Sehen Sie sich die [vollständigen Multivarianz-Aktivitäten (MVT)](../c-activities/c-multivariate-testing/multivariate-testing.md#concept_628695CDC71B449B8DCC2F5654C11499) mit der Elementbeitragsanalyse an, um zu sehen, ob sie Ihren Anforderungen entspricht.
...
Mithilfe der für jedes Ziel verfügbaren Option [Erweiterte Einstellungen](../c-activities/t-test-ab/t-test-create-ab/ab-goals-and-settings.md#section_E2FE441AFB324E498793ABB025ED9974) lässt sich dies leicht bewerkstelligen. Sie haben mehrere Entscheidungsmöglichkeiten dahingehend, was mit dem Benutzer passieren soll, nachdem er das Ziel erreicht hat, und wie Sie die Anzahl erhöhen möchten.
...
Hier kommen [Ziele](../c-activities/t-test-ab/t-test-create-ab/ab-goals-and-settings.md#reference_B25389FD6F3A4989801E740364B089CC) an.
...
Geben Sie den gewünschten Schritt dazu einfach [direkt auf der Seite „Aktivitätsübersicht“ ein](../c-activities/edit-activity.md#concept_BB064C0D4A194BD1A1AE7CCA1E6BB8F0) und beenden Sie diesen Schritt dann mit der Option „Speichern und schließen“.
...
Das ist auch möglich. Verwenden Sie [einfach die Option „Speichern“, um die inkrementellen Änderungen vorzunehmen, ohne den Schritt zu beenden](../c-activities/edit-activity.md#concept_BB064C0D4A194BD1A1AE7CCA1E6BB8F0).
...
Nutzen Sie die Leistungsfähigkeit [formularbasierter Aktivitäten](../c-experiences/form-experience-composer.md#task_FAC842A6535045B68B4C1AD3E657E56E) mit [JSON-Angeboten](../c-experiences/c-manage-content/create-json-offer.md#concept_63C7BEE1F0DB4A7596D997219B7C136D), um Ihr Ziel zu erreichen.
...
Verwenden Sie die [Funktion „Nur Aktivität“-Zielgruppe](../c-target/creating-activity-only-audience.md#concept_A6BADCF530ED4AE1852E677FEBE68483), um die für die Aktivität lokalen Zielgruppen zu definieren.

**Wie kann ich Benutzer auf Basis ihrer Standorte ansprechen?**

Probieren Sie die [Geo-Zielgruppen](../c-target/c-audiences/c-target-rules/geo.md#concept_5B4D99DE685348FB877929EE0F942670) aus. Machen Sie sich mit den Genauigkeitsebenen dieser Funktion vertraut.

**Kann ich Benutzer auf Basis einiger Attribute auf der Seite in der Sitzung ansprechen?**

Verwenden Sie am besten Mboxes und [benutzerdefinierte Zielgruppen](../c-target/c-audiences/c-target-rules/custom-parameters.md#concept_C4C6E00D7C5A4BE9B72D471DB2E3027B) zur Bereitstellung des richtigen Erlebnisses.
...
Versuchen Sie es mit der [Funktion „Profilskripte“](../c-target/c-visitor-profile/profile-parameters.md#concept_8C07AEAB0A144FECA8B4FEB091AED4D2). Hiermit lassen sich Erlebnisse wirksam anpassen. Sie müssen dafür jedoch Code schreiben.
...
Sehen Sie sich die [Vorlagenregeln](../c-experiences/c-visual-experience-composer/temtest.md#task_2539D51A18044F82B0D9895636546781) an, um der Aktivität viele ähnlich strukturierte Seiten hinzuzufügen, während Sie das Erlebnis für die einzelne, angegebene URL erstellen.
...
Versuchen Sie, die Seite mit [Enhanced Experience Composer](../c-experiences/experiences.md#section_34265986611B4AB8A0E4D6ACC25EF91D) zu laden.

**Warum wird meine Site in Visual Experience Composer (VEC) nicht geladen?**

Konsultieren Sie die [Informationen zur Fehlerbehebung](../c-experiences/c-visual-experience-composer/r-troubleshoot-composer/troubleshoot-composer.md#reference_77743144F10143A3A89D56E116D296E4) auf der Hilfeseite. Wenden Sie sich an den [Adobe Support](../cmp-resources-and-contact-information.md#reference_ACA3391A00EF467B87930A450050077C), wenn keine dieser Vorgehensweisen funktioniert.
...
Lesen Sie zudem, wann und warum [Enhanced Experience Composer](../c-experiences/experiences.md#section_34265986611B4AB8A0E4D6ACC25EF91D) hilfreich sein kann. Sie müssen sich möglicherweise an Ihre IT-Abteilung wenden, um auch die  [allowlist Adobe&#39;s proxy servers](../c-experiences/c-visual-experience-composer/experience-composer-best-practices.md#concept_E284B3F704C04406B174D9050A2528A6) as well.
...
Beschäftigen Sie sich mit der Funktion [Mobile Viewports](../c-experiences/c-visual-experience-composer/mobile-viewports.md#concept_8E45527C4ABC41D59AA3553BEDC76FA5). Beachten Sie, dass sie nur funktioniert, wenn „Enhanced Experience Composer“ aktiviert ist.
...
Wenden Sie sich an Adobe, um [sicherzustellen, dass Ihr Konto für Scene7 eingerichtet ist](../administrating-target/scene7-settings.md#task_37AD0768EFBA4E588955FE3D5DD670A5). Nach der Bereitstellung können Sie ein Bild problemlos mit einem anderen Bild tauschen.
...
Das können Sie ganz einfach über unsere [Funktion „Mehrfach-Erlebnis-Version“](../c-activities/t-test-ab/t-test-create-ab/target-experience-to-multiple-audiences.md#task_0138112E283A4A5B9F8AB9AAF2FBC2FF) tun. Beachten Sie die Details in Bezug auf die Bereitstellung in solchen Tests.

**Wie kann ich sehen, welche Änderungen ich in Visual Experience Composer (VEC) vorgenommen habe?**

Ihre Änderungen werden immer im [Code-Editor](../c-experiences/c-visual-experience-composer/c-vec-code-editor/vec-code-editor.md#concept_B3A6E9EE3A60406DB640E205EA1745B5) angezeigt. Auf der Registerkarte „Änderungen“ werden der CSS-Selektor oder die Mbox angezeigt, die Sie auf Ihr Angebot angewendet haben.
...
Verwenden Sie den [Debugger](../c-activities/c-troubleshooting-activities/content-trouble.md#concept_D2548B486C984B1E97ED7A72075B8EEA) und suchen Sie nach [Aktivitätskollisionen](../c-experiences/c-visual-experience-composer/activity-collisions.md#concept_0BC6B929592744DFA7DA01FF4F91052E).
...
Wir verfügen über eine [Weiterleitungs-URL](../c-experiences/c-manage-content/offer-redirect.md#task_33C80CD722564303B687948261484F94), mit der Sie Benutzer zur gewünschten Seite weiterleiten können (mit oder ohne die aktuellen Abfrageparameter).
...
Die [Funktion „Antwort-Token“](../administrating-target/response-tokens.md#concept_2B21B222F6A344D68CA5929817E836C4) bietet eine Lösung dafür.
...
Zur Optimierung und Personalisierung auf Mobilgeräten müssen Sie [formularbasierte Aktivitäten](../c-experiences/form-experience-composer.md#task_FAC842A6535045B68B4C1AD3E657E56E) zusammen mit [Adobe SDK](../c-target-mobile-app/mobile-enable-target-in-sdk.md#task_FCA99AD0785A44E995468776AE76FE91) verwenden. Weitere Informationen zu [Target für mobile Apps](../c-target-mobile-app/target-mobile-app.md#concept_80126FF457724DE788CE37264A047559).
