...
| Funktion | Details |
| --- | --- |
| [!UICONTROL Analytics for Target] (A4T) | Wenn Sie auf der [!UICONTROL View in Analytics] auf den Link &quot;[!UICONTROL Reports]&quot; in einer Aktivität klicken, die [!DNL Analytics] als Berichtsquelle (A4T) verwendet, wird [!DNL Analysis Workspace] jetzt geöffnet. Zuvor wurden durch den Link die Berichte von [!DNL Analytics] geöffnet. (TGT-36959) |
