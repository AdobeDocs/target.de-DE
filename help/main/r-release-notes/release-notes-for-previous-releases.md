...
* **Profilparameter &#39;In Between&#39;-Regel wird nicht in Kriterien gespeichert.** Mit dieser Fehlerbehebung wird ein Problem behoben, bei dem Kriterienregeln, die den Operator **In Between** für Profilparameter verwenden, nicht korrekt gespeichert wurden. Wenn Benutzer zuvor eine Regel mit dem Operator **In Between** konfiguriert und Bereichswerte eingegeben haben, schienen die Kriterien erfolgreich zu speichern, aber die Regel wurde beim erneuten Öffnen oder Bearbeiten der Kriterien nicht mehr angezeigt. Der Fix stellt sicher, dass **In Between**-Regeln ordnungsgemäß gespeichert werden und beibehalten werden, wenn Kriterien erneut geöffnet werden. (TGT-54498)
...
* **Machen Sie die linke Navigation ausblendbar.** Die linke Navigation ist jetzt für alle Registerkarten reduzierbar und erweiterbar. In ausgeblendetem Zustand werden Symbole mit QuickInfos angezeigt. Wenn diese Option erweitert ist, werden sowohl Symbole als auch Text angezeigt. Diese Verbesserung bietet Benutzern bei Bedarf mehr Bildschirmplatz und ermöglicht gleichzeitig einen schnellen Zugriff auf Navigationsoptionen. (TGT-54608)
...
* **Standardwert für experienceEditorType ist „visual“, wenn das Backend null zurückgibt.** Mit dieser Korrektur wird ein Problem behoben, bei dem der Wert &quot;`experienceEditorType`&quot; in einigen Szenarien als NULL zurückgegeben wurde. Dies führt zu unbeabsichtigtem Verhalten auf der Benutzeroberfläche, bei dem der Editortyp nicht ordnungsgemäß initialisiert wurde. (TGT-54690)
...
* **Eigenschafts-Token wird nach dem Entfernen nicht automatisch erneut hinzugefügt.** Mit dieser Korrektur wird ein Problem behoben, bei dem Eigenschaftentoken, deren Auswahl von Benutzern aufgehoben wurde, beim Bearbeiten einer Aktivität automatisch erneut hinzugefügt wurden. Wenn Benutzer zuvor eine automatisch erkannte Eigenschaft entfernt haben und zwischen den Schritten navigierten, hat das System die entfernte Eigenschaft ohne Warnung oder Aufforderung wieder eingeführt, was dazu führte, dass Aktivitäten für unerwartete Eigenschaften aktiviert wurden. Das Update stellt sicher, dass ein einmal entferntes Eigenschaftstoken bei allen nachfolgenden Bearbeitungen und bei der Navigation entfernt wird. (TGT-54040)
...
* **Aktivität kann nicht kopiert werden - ungültige Benutzereingabe.** Das Problem, das dazu führt, dass Benutzern beim Kopieren einer Aktivität ein nicht hilfreicher Fehler &quot;Ungültige Benutzereingabe&quot; angezeigt wird, wurde behoben. Bisher wurden beim Duplizieren einer Aktivität die arbeitsbereichsspezifischen Eigenschaftszuweisungen nicht beibehalten, sodass das Backend die Speicheranforderung ablehnte, da ABActivity mindestens eine Eigenschaft benötigt, die zu einem nicht standardmäßigen Arbeitsbereich gehört. Diese Inkongruenz löste einen generischen Fehler in der Benutzeroberfläche aus, sodass Benutzer keine Anleitung erhalten. Die Korrektur stellt sicher, dass Arbeitsbereichszuweisungen während des Kopiervorgangs korrekt beibehalten werden, sodass Benutzer die kopierte Aktivität ohne Änderungen speichern können und irreführende Validierungsfehler verhindert werden. (TGT-54282)
* **Arbeitsbereichsspalte aktivieren, die der Web-Editor anbietet.** Dieses Update behebt Kundenverwirrungen, die durch Angebote von [!UICONTROL Default Workspace] verursacht wurden, die in anderen Arbeitsbereichen im Web-Editor angezeigt werden. Obwohl dieses Verhalten wie vorgesehen funktioniert, sind [!UICONTROL Default Workspace] Angebote absichtlich in allen Arbeitsbereichen sichtbar. Kunden berichteten jedoch, dass die Benutzeroberfläche den Ursprung des Arbeitsbereichs nicht eindeutig angegeben hat, insbesondere beim Erstellen von Aktivitäten in einem nicht standardmäßigen Arbeitsbereich wie &quot;Genehmiger&quot;. Zur Verbesserung der Übersichtlichkeit wurde die Spalte &quot;[!UICONTROL Workspace]&quot; jetzt in der Angebotsliste des Web-Editors aktiviert, sodass Benutzer leicht unterscheiden können, zu welchem Arbeitsbereich jedes Angebot gehört, und eine Fehlinterpretation der angezeigten zusätzlichen Angebote verhindert wird. (TGT-54138)
...
* **Warnhinweis zur Aufhebung der Auswahl.** Mit dieser Aktualisierung wird eine visuelle Warnung eingeführt, um Benutzer deutlich zu informieren, wenn sie eine automatisch erkannte Eigenschaft im Aktivitäts-Editor deaktivieren. Früher wurde eine automatisch erkannte Eigenschaft entfernt, ohne dass angegeben wurde, dass die Eigenschaft dauerhaft gelöscht würde, was zu einem versehentlichen Verlust der Zielkonfiguration führen könnte. Die Korrektur fügt ein Warnsymbol hinzu, das dem Verhalten in der alten Benutzeroberfläche entspricht, um Benutzer zu benachrichtigen, dass durch Deaktivieren der Eigenschaft diese aus der Aktivität entfernt wird. (TGT-54121)
...
* **Fügen Sie automatisch erkannten Text zur Eigenschaftenliste hinzu.** Diese Verbesserung aktualisiert die [!UICONTROL Properties List], um alle Eigenschaften, die automatisch vom System erkannt wurden, deutlich zu kennzeichnen. Wenn eine automatisch erkannte Eigenschaft auch in der für den Benutzer sichtbaren [!UICONTROL Properties List] vorhanden ist, wird jetzt der Text &quot;(Automatisch erkannt)&quot; neben dem Namen angezeigt. Dabei wird der im Status &quot;~ActivityEditorSlice~&quot; gespeicherte Wert verwendet. Dies spiegelt das Verhalten der alten Benutzeroberfläche wider und erleichtert es Benutzern, zwischen manuell ausgewählten und automatisch identifizierten Eigenschaften zu unterscheiden. (TGT-54120)
* **Automatisch erkannte [!UICONTROL Properties] in den Status hinzufügen.** Dieses Update stellt sicher, dass der Status ~ActivityEditorSlice.ExperienceEditor~ eine aktuelle Liste aller automatisch erkannten Eigenschaften-IDs beibehält, die vom Web-Editor an die Registerkarte Aktivität [!UICONTROL Experiences] übergeben werden. Jedes Mal, wenn der Benutzer auf die Registerkarte &quot;[!UICONTROL Experiences]&quot; navigiert, wird der Status mit allen neu erkannten Eigenschaften aktualisiert, während Duplikate verhindert werden. Auf diese Weise wird eine genaue Verfolgung und ein zuverlässiges nachgelagertes Verhalten sichergestellt. (TGT-54119)
...
* Die **[!UICONTROL Message]-Spalte konnte in der aktualisierten Benutzeroberfläche zeitweise keine Produktdaten anzeigen.** Es wurde ein Problem in der aktualisierten [!UICONTROL Recommendations]-Benutzeroberfläche behoben, bei dem in der [!UICONTROL Message]-Spalte in [!UICONTROL Catalog Search] zeitweise keine Produktdaten angezeigt wurden, obwohl Werte im Feed vorhanden waren. In der Spalte werden jetzt für alle Produkte konsistent die richtigen Nachrichtenwerte angezeigt. So ist eine zuverlässige Sichtbarkeit gewährleistet, ohne dass eine manuelle Spaltenumkonfiguration erforderlich ist. (TGT-52777)
* Die Schaltfläche &quot;**[!UICONTROL Download Recommendations Data]&quot; ist nach dem Speichern der Aktivität in der aktualisierten Benutzeroberfläche nicht sichtbar.** Es wurde ein Problem in der aktualisierten Benutzeroberfläche behoben, bei dem die Schaltfläche [!UICONTROL Download Recommendations Data] für bestimmte gespeicherte Aktivitäten auch nach dem erneuten Speichern nicht angezeigt wurde. Die Schaltfläche wird jetzt über alle Aktivitäten hinweg konsistent angezeigt, sodass Benutzerinnen und Benutzer Empfehlungsdaten zuverlässig exportieren können, ohne Problemumgehungen zu benötigen. (TGT-53802)
...
+++Weitere Informationen
* **In der aktualisierten Benutzeroberfläche können nicht mehrere Zielgruppen für die Berichterstellung ausgewählt werden.** Es wurde ein Problem in der aktualisierten Benutzeroberfläche behoben, bei dem Benutzer beim Bearbeiten einer Aktivität nicht mehrere neu erstellte Berichterstellergruppen gleichzeitig auswählen konnten. Es können jetzt mehrere Zielgruppen gleichzeitig zugewiesen werden, was die Flexibilität und Effizienz bei der Einrichtung von Berichten verbessert. (TGT-53253)
...
+++Details anzeigen
* **Es wurden mehrere Lokalisierungsfehler in der koreanischen und der japanischen Benutzeroberfläche behoben.** (TGT-54003, TGT-54004, TGT-54006, TGT-54007 und TGT-54018)
...
+++Details anzeigen
* Das Entfernen von Aktivitätsänderungen wurde durch das **[!UICONTROL Delete Modification]-Schaltflächenproblem verhindert.** Es wurde ein Problem behoben, bei dem die Schaltfläche &quot;[!UICONTROL Delete Modification]&quot; in der [!DNL Target]-Benutzeroberfläche nicht funktionierte, sodass Benutzer keine Änderungen in Aktivitäten entfernen konnten. Die Schaltfläche funktioniert nun erwartungsgemäß, sodass Änderungen zuverlässig und ohne Verzögerung gelöscht werden können. (TGT-53728)
...
+++ Weitere Informationen
* **Ein Benutzerfähigkeitsproblem in der aktualisierten Benutzeroberfläche wurde behoben**. [!UICONTROL Observers] kann jetzt Aktivitäten mithilfe der Option [!UICONTROL View Activity] in der Vorschau anzeigen, genau wie in der alten Benutzeroberfläche. (TGT-51741)
...
* **Zielgruppenbasierte Berichtsdiagramme zeigen jetzt die Konversionsdaten korrekt an.** Es wurde ein Problem auf der Registerkarte &quot;[!UICONTROL Reports]&quot; behoben, das dazu führte, dass Diagramme bei der Auswahl von nicht standardmäßigen Zielgruppen fehlschlugen. Daten und Konfidenzmetriken waren zwar verfügbar, doch die visuelle Grafik wies nur eine durchgezogene Linie auf, was die Analyse erschwerte. (TGT-53769)
* **Die [!UICONTROL Targeting]-Benutzeroberfläche weist jetzt eindeutig auf ausgeschlossene Zielgruppenregeln hin.** Es wurde ein Problem im Abschnitt &quot;[!UICONTROL Targeting]&quot; der Benutzeroberfläche zum Erstellen von Aktivitäten behoben, bei dem die auf &quot;[!UICONTROL Exclude]&quot; festgelegten Zielgruppenregeln nicht eindeutig angezeigt wurden. Dies führte zu Verwirrung bei der Überprüfung der Zielgruppenlogik, insbesondere bei Zielgruppen, die bestimmte URLs ausschließen. (TGT-53809)
* **Die Zielgruppendefinitionswerte können jetzt auf der Registerkarte [!UICONTROL Targeting] ausgewählt und kopiert werden.** Es wurde ein Problem in der Schnittstelle zum Erstellen von Aktivitäten behoben, durch das Benutzer daran gehindert wurden, auf der Registerkarte &quot;[!UICONTROL Targeting]&quot; Zielgruppenregelwerte auszuwählen und zu kopieren. Diese Funktion war in der veralteten Benutzeroberfläche verfügbar, fehlt jedoch in der aktualisierten Benutzeroberfläche. (TGT-53856)
...
* **Es wurde ein Fehler bei der Übersetzung von &quot;Angebot geändert&quot; im Kontext des zh_CN-Seiteneditors behoben.** Es wurde ein Übersetzungsfehler im zh_CN-Gebietsschema behoben, bei dem &quot;Angebot geändert&quot; fälschlicherweise als &quot;更改了报价&quot; dargestellt wurde, was auf ein Angebot zu einem kommerziellen Preis hindeutet. Im Abschnitt Typografie > Überschriftenstil > Blockzitat bezieht sich der Begriff auf ein Formatierungselement - Anführungszeichen - und nicht auf die Preisgestaltung. (TGT-53845)
...
+++Details anzeigen
* **&quot;[!UICONTROL Export order details to CSV]&quot; lädt jetzt vollständige Daten herunter.** Es wurde ein Problem in der aktualisierten [!UICONTROL Overview]-Benutzeroberfläche behoben, durch das die Option &quot;[!UICONTROL Export Order details to CSV]&quot; leere Dateien heruntergeladen hat, selbst wenn gültige Berichtsdaten vorhanden waren. (TGT-53787)
...
* **VEC-Ladeproblem konnte nicht reproduziert werden.** Wir haben ein gemeldetes Problem untersucht, bei dem der VEC beim Bearbeiten vorhandener Aktivitäten an &quot;[!UICONTROL Applying initial modifications]&quot; hängen blieb. Es wurde vermutet, dass das Verhalten mit dem HTML von Inhalten verknüpft ist, denen ein übergeordnetes Element fehlt. Wir werden die Überwachung auf Wiederholung fortsetzen und empfehlen, strukturierte Container für HTML-Angebote zu verwenden, um die Stabilität zu gewährleisten. (TGT-53972)
* Der Modus &quot;**[!UICONTROL Design]&quot; im VEC verhält sich nicht mehr wie der Modus &quot;[!UICONTROL Browse]&quot; zeitweise.** Es wurde ein Problem in der Benutzeroberfläche behoben, bei dem der Modus &quot;[!UICONTROL Design]&quot; sich zeitweise wie der Modus &quot;[!UICONTROL Browse]&quot; verhielt, sodass auf `<a>` Links geklickt werden konnte und die Elementauswahl verhindert wurde. Dies führte dazu, dass der Hover-Rahmen verschwand und die Arbeitsabläufe für Änderungen blockiert wurden. (TGT-53136)
...
* **Aktualisierungen des Angebotscodes in Aktivitäten von Automated Personalization werden jetzt fehlerfrei gespeichert.** Es wurde ein Problem in der Benutzeroberfläche für die neue Erstellung behoben, das einen Fehler &quot;[!UICONTROL Invalid user input]&quot; beim Aktualisieren des Angebotscodes in [!UICONTROL Automated Personalization]-Aktivitäten verursachte. Der Fehler hindert Benutzer daran, Änderungen zu speichern, selbst wenn die Eingabe gültig war. (TGT-53586)
...
* **Die Regeln für den Zielgruppenausschluss wurden fälschlicherweise als Einschluss in der [!DNL Target]-Benutzeroberfläche angezeigt.** Zielgruppen, für die Ausschlussregeln konfiguriert wurden, wurden beim Bearbeiten von Zielgruppen in einer Aktivität als eingeschlossen angezeigt. Obwohl die Ausschlusslogik während der Ausführung korrekt angewendet wurde, konnte die Benutzeroberfläche die Regel nicht korrekt wiedergeben, ohne die Bezeichnung &quot;exclude&quot; anzugeben. Die [!DNL Target]-Benutzeroberfläche zeigt jetzt die Ausschlussregeln sowohl in der Zielgruppen-Konfiguration als auch in den Zielgruppen-Workflows korrekt an, wodurch Klarheit und Konsistenz für die Kampagneneinrichtung gewährleistet sind. (TGT-53808)
...
+++Weitere Informationen
* **Es wurde ein Problem behoben, durch das bei `redirectOptions` Umleitungsangebote `includeContent=true` nicht in die Nutzlast aufgenommen haben.** Kunden, die Umleitungsangebote mit `includeContent=true ` abrufen, fehlte das Feld `redirectOptions` in der Antwort-Payload. Diese Inkonsistenz wirkte sich auf Workflows wie das Kopieren von Angeboten und die Erstellung von Aktivitäten aus. Umleitungsangebote enthalten `redirectOptions` jetzt korrekt, wenn Inhalte angefordert werden. (TGT-53737)
...
* **Es wurde ein Problem behoben, bei dem die Leiste &quot;[!UICONTROL Manage Content]&quot; in [!UICONTROL Automated Personalization]-Aktivitäten inkonsistente Positionsbezeichnungen anzeigte.** Kunden berichteten, dass die Leiste &quot;[!UICONTROL Manage Content]&quot; nicht übereinstimmende Standortnummern auf den Registerkarten &quot;[!UICONTROL Experiences]&quot; und &quot;[!UICONTROL Offers]&quot; anzeigte. (z. B. Speicherort 2 und Speicherort 4 in &quot;Erlebnisse&quot; und Speicherort 1 und Speicherort 2 im Angebot), selbst wenn nur zwei Speicherorte konfiguriert wurden. Standortbeschriftungen sind jetzt konsistent und genau auf Änderungen abgebildet, was die Klarheit und Benutzerfreundlichkeit beim Erstellen von Aktivitäten verbessert. (TGT-52934)
* **Es wurde ein Problem behoben, bei dem Änderungen in der VEC nach dem Speichern verloren gingen.** Kunden berichteten, dass die Seite nach dem Speichern einer Änderung in der VEC aktualisiert und die Änderung auf ihre vorherige Version zurückgesetzt wurde. Dieses Problem führte dazu, dass die neuesten Updates verloren gingen, es sei denn, die gesamte Aktivität wurde sofort gespeichert. Die Änderungen werden jetzt nach dem Speichern korrekt beibehalten und der Editor stellt die Änderungen nicht mehr unerwartet wieder her, sodass ein zuverlässiges Erlebnis im Workflow zum Erstellen von Aktivitäten sichergestellt wird. (TGT-53500)
...
* Die gleiche Datenstrom-ID + Sandbox-Namenspaar kann nicht für mehrere [!DNL Target] Zielverbindungen wiederverwendet werden.
* Die gleiche Datenstrom-ID kann für verschiedene Verbindungen nur verwendet werden, wenn sie in verschiedenen Sandboxes konfiguriert sind.
...
* Die Schaltfläche &quot;**[!UICONTROL Download full CSV report]&quot; wurde in der Ansicht &quot;[!UICONTROL Important attributes]&quot; wiederhergestellt.** Es wurde ein Problem in der aktualisierten Benutzeroberfläche zur Erstellung von Aktivitäten behoben, bei dem die Schaltfläche &quot;[!UICONTROL Download full CSV report]&quot; im Abschnitt &quot;[!UICONTROL Important Attributes]&quot; in der Berichtsansicht fehlte. Dieser Fix stellt den Zugriff auf herunterladbare Einblicke wieder her und gewährleistet konsistente Funktionen sowohl auf der aktualisierten als auch auf der alten Benutzeroberfläche. (TGT-53238)
* **Gelöste UI-Probleme, die [!UICONTROL Auto Target] Reporting in der aktualisierten Übersichts-Benutzeroberfläche betreffen.** Es wurden mehrere UI-Probleme in der aktualisierten Übersichtsoberfläche behoben, die sich auf [!UICONTROL Auto Target] Aktivitätsberichte auswirkten. Zu diesen Fehlerbehebungen gehören:
   ...
   * Falsche Farbanzeige für das Kontrollkästchen &quot;Modelle gebaut&quot;
   * Nicht funktionierender Diagrammbericht trotz Datenabweichung in [!DNL Analytics]
   * Fehlender Download-Link für [!UICONTROL Automated Segments]- und [!UICONTROL Important Attributes]-Berichte
   * Anzeige des [!UICONTROL Automated Segments]-Berichts unterbrochen

  Diese Korrekturen stellen das erwartete Berichtsverhalten wieder her und verbessern die Sichtbarkeit der Leistung von [!UICONTROL Auto Target] auf der aktualisierten Benutzeroberfläche. (TGT-53484)
...
* **Für die Zukunft geplante Aktivitäten haben in der [!UICONTROL Live]-Übersicht fälschlicherweise den Status &quot;[!UICONTROL Activity]&quot; angezeigt**: Kundinnen und Kunden haben beobachtet, dass Aktivitäten, die in der Zukunft beginnen sollen, in der [!UICONTROL Live]-Übersicht fälschlicherweise als &quot;[!UICONTROL Activity]&quot; gekennzeichnet wurden. Diese Statusabweichung wurde behoben, und geplante Aktivitäten werden jetzt korrekt als &quot;[!UICONTROL Scheduled]&quot; angezeigt, ohne dass die Seite aktualisiert werden muss. (TGT-52835)
...
+++Details anzeigen
* **Produktliste war im Dialogfeld &quot;[!UICONTROL View Collection]&quot; nicht sichtbar:** Zuvor konnten Kunden die Produktliste nicht sehen, wenn sie eine Sammlung auf der Registerkarte &quot;[!UICONTROL Recommendations]&quot; ansahen. Das [!UICONTROL View Collection]-Dialogfeld zeigt nun die zugehörigen Produkte korrekt an, was die Transparenz und Benutzerfreundlichkeit in der aktualisierten [!UICONTROL Recommendations]-Benutzeroberfläche verbessert. (TGT-50531)
...
* **Die erweiterte Suche in der aktualisierten [!UICONTROL Product Catalog Search]-Benutzeroberfläche hat keine Vorschläge bereitgestellt**: Kundinnen und Kunden, die die Funktion für die erweiterte Suche in der aktualisierten [!UICONTROL Product Catalog Search]-Benutzeroberfläche verwenden, mussten genaue Werte mit korrekter Schreibweise eingeben, da keine Vorschläge angezeigt wurden. Dieses Problem machte es schwierig, Produkte effizient zu finden. Vorschläge werden jetzt bei der Eingabe der erweiterten Suche wie erwartet angezeigt. (TGT-52008)
* **Einige genehmigende Personen konnten keine Produkte in[!UICONTROL Product Catalog Search]** anzeigen: Kundinnen und Kunden mit [!UICONTROL Approver] Berechtigungen konnten keine Produkte in [!UICONTROL Product Catalog Search] sehen, obwohl andere Benutzende mit identischen Rollen Zugriff hatten. Dieses Problem wurde durch eine Berechtigungsinkonsistenz verursacht, die sich auf die Katalogsichtbarkeit auswirkte. Alle genehmigenden Personen können jetzt Produkte wie erwartet im [!UICONTROL Recommendations] Abschnitt anzeigen. (TGT-53617)
...
* **Der Wechsel zwischen Zielgruppen auf der Seite „Berichte“ verursachte Fehler in der Target**-Benutzeroberfläche: Bei der Auswahl bestimmter Zielgruppen im Abschnitt &quot;[!UICONTROL Reports]&quot; traten Fehler auf. Dieses Problem wurde durch eine ungültige Behandlung von Zielgruppen in Backend-GraphQL-Aufrufen verursacht, was zu unerwarteten Fehlern und fehlenden Daten führte. Das Problem wurde behoben, und Desktop-Zielgruppen werden jetzt ohne Fehler geladen - auch wenn keine Daten verfügbar sind. (TGT-53370)
* **[!UICONTROL Graph view]im Abschnitt &quot;[!UICONTROL Reports]&quot; hat keine Werte aus &quot;[!DNL Analytics]**&quot; angezeigt: Für Kunden, die auf &quot;[!UICONTROL Graph view]&quot; im Abschnitt &quot;Re-Ports&quot; zugreifen, fehlten Daten, wobei alle Werte als Null angezeigt wurden. Dieses Problem wurde durch falschen Datenabruf von [!UICONTROL Analytics] verursacht. [!UICONTROL Graph view] zeigt jetzt wie erwartet präzise Werte an. (TGT-52792)
+++

**[!UICONTROL Visual Experience Composer] (VEC)**

+++Details anzeigen
* **Fehler beim Klicken auf &quot;Cookies akzeptieren&quot; mithilfe von [!UICONTROL Enhanced Experience Composer] (EEC) aufgrund einer fehlenden Funktion**: Kunden haben berichtet, dass der Versuch, Cookies über die EEC zu akzeptieren, zu einem Konsolenfehler geführt hat: `handleclickAcceptAllButton is not defined`. Die Cookie-Annahmefunktion funktioniert jetzt wie erwartet und gewährleistet ein reibungsloseres Erlebnis bei der Aktivitätserstellung in der aktualisierten Benutzeroberfläche. (TGT-52794)
* **Die neue EEC-Benutzeroberfläche konnte bestimmte Seiten nicht laden, die zuvor in der älteren UI unterstützt wurden**: Kunden berichteten, dass die neue EEC einige Seiten nicht laden konnte, auf die trotz des auf der Site vorhandenen iframe-Busting-Codes in der älteren UI zugegriffen werden konnte. Der aktualisierte Prozess zur Erstellung von Aktivitäten unterstützt jetzt das Laden dieser Seiten und stellt die Kompatibilität für Workflows zur Aktivitätserstellung wieder her. (TGT-53061)
...
* **Das Löschen aller Datumswerte mithilfe der Rücktaste hat zu einem Absturz der Seite geführt**: Kundinnen und Kunden, die Aktivitäten im Abschnitt &quot;[!UICONTROL Goals & Settings]&quot; planen, haben einen Absturz erlebt, wenn sie die Rücktaste verwendet haben, um alle Werte aus den Feldern &quot;[!UICONTROL Specified Date & Time]&quot; zu löschen. Dieses Problem wurde durch einen Null-Referenzfehler in der Datumsbehandlungslogik verursacht. Die Seite verarbeitet jetzt leere Datumseingaben ohne Absturz ordnungsgemäß. (TGT-53624)
* **In [!UICONTROL Product Catalog Search] sind aufgrund einer ungültigen Nutzlast keine Produkte aufgetreten**: Für Kunden, die auf den Abschnitt [!UICONTROL Recommendations] in [!UICONTROL Product Catalog Search] zugreifen, wurden leere Ergebnisse gefunden, die durch eine ungültige GraphQL-Nutzlast verursacht wurden. Aufgrund dieses Backend-Fehlers konnten Produktdaten nicht korrekt geladen werden. Produkte werden jetzt in der aktualisierten Benutzeroberfläche wie erwartet angezeigt. (TGT-53630)
...
* **Abschnitt &quot;[!UICONTROL Failed] und [!UICONTROL Draft] Aktivitäten“ in aktualisiertem VEC eingestellt**: Die Optionen für [!UICONTROL Failed] und [!UICONTROL Draft] Aktivitäten wurden aus dem aktualisierten VEC entfernt. Die neue Benutzeroberfläche unterstützt keine Entwurfsstatus mehr, und fehlgeschlagene Kampagnen werden nicht im Backend gespeichert. Diese Optionen sind nicht mehr relevant. Die zugehörigen Filter und Backend-Felder (z. B. `uiSyncFailed`, `errorMessage`) wurden ebenfalls entfernt, um die Aktivitätsverwaltung zu optimieren. (TGT-53150)
* **Anmeldung beim VEC für eine Aktivität nicht möglich**: Kunden, die versuchen, sich über den VEC bei ihrer Website anzumelden, wurden wiederholt zur Anmeldeseite weitergeleitet, wodurch der Zugriff auf die Aktivitätsbearbeitung verhindert wurde. Dieses Problem war intern nicht reproduzierbar und könnte mit der Verarbeitung von sitzungsseitigen Sitzungen zusammenhängen. Der Anmeldefluss wurde stabilisiert und Kunden können jetzt ohne Umleitungsfehler auf die VEC zugreifen. (TGT-53524)
* **Das zweimalige Drücken der Zurück-Schaltfläche im Modus [!UICONTROL Browse] führte zum Absturz des VEC**: Bei Kunden, die im VEC durch den Modus [!UICONTROL Browse] navigieren, kam es zu Abstürzen, wenn sie zweimal die Zurück-Schaltfläche des Browsers drückten. Dieses Problem führte dazu, dass der Editor eingefroren wurde und eine Seitenaktualisierung erforderlich war. Der Editor behandelt die Rücknavigation jetzt zuverlässig, ohne dass es zu einem Absturz kommt. (GT-53568)
...
* **Es wurde ein Problem mit dem Layout des Dialogfelds „Details anzeigen“ in der aktualisierten Benutzeroberfläche behoben**: Das Layout des Modals „Details anzeigen“ in der aktualisierten Benutzeroberfläche wurde geändert, um die Klarheit und Benutzerfreundlichkeit zu verbessern. Das Dialogfeld enthält jetzt zwei Registerkarten:
   ...
   * **Es wurde ein Problem behoben, durch das entfernte Promotions in Empfehlungsaktivitäten nach dem Speichern wieder auftraten**: Kunden berichteten, dass die Promotions nach dem Entfernen von [!UICONTROL front] oder [!UICONTROL back] Promotions aus [!DNL Recommendations] Aktivitäten und dem Speichern der Aktivität nach dem erneuten Öffnen weiterhin angezeigt wurden. Dieses Problem trat sowohl in Staging- als auch in Produktionsumgebungen auf und betraf den aktualisierten Prozess zum Erstellen von Aktivitäten. Das Problem wurde behoben. Aktionen, die aus einer Aktivität entfernt werden, bleiben jetzt nach dem Speichern korrekt erhalten. (TGT-53490)
...
+++Weitere Informationen
* **Problem im Prozess zum Erstellen von Aktivitäten behoben, durch das die Progression zum Schritt [!UICONTROL Targeting] in AP-Aktivitäten blockiert wurde**: Es wurde ein Problem im Prozess zum Erstellen von Aktivitäten behoben, bei dem Kunden nicht zum Schritt [!UICONTROL Targeting] in [!UICONTROL Automated Personalization] (AP)-Aktivitäten fortfahren konnten, wenn nicht zwei Standorte hinzugefügt wurden. Dieses Verhalten unterschied sich vom vorherigen Erlebnis, bei dem ein einzelner Standort mit mehreren Angeboten ausreichend war. Die Anforderung wurde korrigiert, sodass Kundinnen und Kunden weiterhin Einzelspeicherort-Setups als Teil ihrer API-Workflows verwenden können. (TGT-53426)
...
+++Weitere Informationen
* **Es wurde ein Problem behoben, bei dem Kundinnen und Kunden, die auf einen einzigen Arbeitsbereich beschränkt waren, Aktivitäten aus anderen Arbeitsbereichen anzeigen konnten**: Kundinnen und Kunden mit Zugriff auf einen Arbeitsbereich konnten unerwartet Aktivitäten in allen Arbeitsbereichen anzeigen, wenn sie [!UICONTROL All Workspaces] im Prozess zur Erstellung einer Aktivität auswählten. Durch diese Sichtbarkeit bestand die Gefahr, dass es zu unbeabsichtigten Änderungen an Live-Aktivitäten in anderen Arbeitsbereichen kam, die sich möglicherweise auf die Website-Leistung auswirkten. Die Zugriffssteuerungen für Workspace wurden verbessert, um sicherzustellen, dass Kunden nur Aktivitäten in ihrem zugewiesenen Arbeitsbereich anzeigen und mit ihnen interagieren können. (TGT-53101)
* **Es wurde ein Problem behoben, bei dem ein Kunde Aktivitäten von [!UICONTROL Default Workspace] anzeigen konnte, ohne Zugriff zu haben:** Ein Kunde mit Zugriff auf den Staging-Arbeitsbereich war in der Lage, Aktivitäten von [!UICONTROL Default Workspace] über den Prozess zum Erstellen von Aktivitäten anzuzeigen. Dieses Verhalten trat trotz korrekter Backend-Konfiguration und Zugriffsrechten auf. Die Zugriffskontrollen für den Arbeitsbereich wurden verbessert, um sicherzustellen, dass Kunden Aktivitäten nur in ihrem zugewiesenen Arbeitsbereich anzeigen können.(TGT-53297)
...
* **Feldverhalten für getrackte Elemente im Klick-Tracking-Modus korrigiert, um nicht gespeicherte Eingaben zu verhindern und die Klarheit zu verbessern**: Es wurde ein Problem im Prozess zur Erstellung einer Aktivität behoben, bei dem das [!UICONTROL Tracked Element] Feld im [!DNL Click Track]-Modus bearbeitbar war, aber den eingegebenen Namen nicht beibehielt, was zu Verwirrung bei den Kunden führte. Das Feld ist jetzt deaktiviert, um nicht gespeicherte Eingaben zu verhindern, und die Benennung ausgewählter Elemente wurde präzisiert, um die Zielkonfiguration und die Verfolgungsgenauigkeit zu verbessern.** (TGT-53458)
* **Problem beim Erstellen von Aktivitäten behoben, das die Benennung von verfolgten Komponenten im Modus [!UICONTROL Click Track] blockierte**: Es wurde ein Problem im Prozess zum Erstellen von Aktivitäten behoben, bei dem Kunden im Modus [!UICONTROL Click Track] keine verfolgten Komponenten benennen konnten. Nach der Eingabe eines Namens schien das Feld bearbeitbar, aber die Eingabe wurde nicht beibehalten. Im Bearbeitungsmodus werden standardmäßig generische Beschriftungen wie &quot;MY PRIMARY GOAL 0&quot; verwendet. Das Feld für verfolgte Elemente ist jetzt deaktiviert und das Benennungsverhalten wurde verdeutlicht, um die Zieleinrichtung und die Tracking-Genauigkeit zu verbessern. (TGT-51396)
...
+++Details anzeigen
* **Es wurde ein Problem im Prozess zur Erstellung von Aktivitäten behoben, bei dem führende Leerzeichen in URLs fehlerhafte QA-Links verursachten**: Es wurde ein Problem im Prozess zur Erstellung von Aktivitäten behoben, bei dem führende Leerzeichen in der Aktivitäts-URL beim Speichern nicht ordnungsgemäß abgeschnitten wurden. Dies führte zu ungültigen QS-Verknüpfungen und falscher Formatierung im Backend. Nach dem Update werden URLs jetzt sauber gespeichert, wodurch fehlerhafte Links verhindert und die Zuverlässigkeit von QA-Workflows für Kunden verbessert wird. (TGT-53427)
...
* **Fehlende Produkt-IDs in der Recommendations-Detailansicht während der Aktivitätserstellung wurden behoben**: Es wurde ein Problem im [!DNL Recommendations]-Aktivitätserstellungsprozess behoben, bei dem Produkt-IDs auf dem Produktdetailbildschirm fehlten, was es Kunden erschwerte, Produkt-IDs während Workflows zu kopieren oder zu referenzieren. Die Produkt-IDs werden jetzt klar in der Detailansicht angezeigt, was die Sichtbarkeit verbessert und eine effizientere Produktverwaltung für Kunden unterstützt. (TGT-51964)
* **Problem beim Erstellen von Aktivitäten behoben, durch das Produktnachrichten nicht in der Empfehlungsansicht angezeigt werden konnten**: Es wurde ein Problem im Prozess zum Erstellen von Aktivitäten behoben, durch das in der Spalte &quot;[!UICONTROL Message]&quot; in der Ansicht &quot;[!DNL Recommendations]&quot; keine Produktdaten angezeigt wurden, obwohl Nachrichten vorhanden waren. Kunden mussten die Spalte manuell entfernen und erneut hinzufügen, um den Inhalt vorübergehend anzuzeigen, der beim Scrollen oder Suchen oft wieder verschwand. Diese Aktualisierung stellt die konsistente Sichtbarkeit von Produktnachrichten wieder her und verbessert die Katalognavigation und die Überprüfungs-Workflows. (TGT-52777)
...
* **Problem mit weißem Bildschirm beim Wechsel zwischen mehreren Erlebnissen im Prozess zur Erstellung einer Aktivität behoben**: Es wurde ein Problem behoben, bei dem das Wechseln zwischen mehreren Erlebnissen zu einem weißen Bildschirm führte. Außerdem wurde ein Problem beim Erstellen von Aktivitäten behoben, bei dem Kunden beim Versuch, mehrere Erlebnisse innerhalb einer Aktivität zu ändern, auf einen weißen Bildschirm stießen. Dieses Problem trat auf, nachdem Änderungen auf zwei Erfahrungen angewendet und dann ein drittes Erlebnis ausgewählt wurden, um weitere Änderungen zu verhindern. Das Update gewährleistet reibungslose Übergänge zwischen den Erlebnissen, sodass Kunden Änderungen ohne Unterbrechung vornehmen können. (TGT-53266)
* **Problem in VEC behoben, durch das benutzerdefinierte Codeänderungen nicht zuverlässig in allen Bearbeitungssitzungen gespeichert wurden**: Problem behoben, durch das im Visual Experience Composer (VEC) vorgenommene benutzerdefinierte Codeänderungen nicht zuverlässig in einem einzigen Versuch gespeichert wurden. Kunden berichteten, dass Änderungen, wie z. B. Formatierungsaktualisierungen oder HTML-Bearbeitungen, auf der Website und in den QA-URLs zeitweise fehlten, selbst wenn die [!UICONTROL Edit Content]-Schaltfläche und die endgültige [!UICONTROL Save]-Schaltfläche verwendet wurden. Diese Regression wurde behoben, sodass alle benutzerdefinierten Code-Änderungen über Bearbeitungssitzungen hinweg wie erwartet bestehen bleiben.** (TGT-53418)
...
* Es wurde ein Problem behoben, bei dem das Kopieren einer Aktivität, die Angebote enthielt, dazu führte, dass in der neuen Aktivität doppelte Angebote erstellt wurden. Dieses Verhalten führte zu unnötigem Durcheinander und Verwirrung, insbesondere beim Verschieben von Aktivitäten zwischen Arbeitsbereichen. Die Korrektur stellt sicher, dass [!DNL Target] Angebote jetzt korrekt und ohne Duplizierung in den Zielarbeitsbereich kopiert werden, was die Aktivitätsverwaltung optimiert und die Workflow-Effizienz verbessert. (TGT-53454)

+++

**Einzelseitenanwendungen (SPA)**
...
* Es wurde ein Problem im aktualisierten VEC behoben, bei dem im [!UICONTROL Manage Content] Abschnitt kein Alternativtext für Erlebnisminiaturansichten angezeigt wurde. Dieses Problem erschwerte es Benutzern, Dokumente zu identifizieren, insbesondere wenn Dateinamen lang oder abgeschnitten waren. (TGT-52291)
* Es wurde ein Fehler behoben, durch den Kunden bei der Konfiguration von [!UICONTROL page delivery]-Regeln in VEC-Aktivitäten auf falsche Validierungsfehler gestoßen sind. Insbesondere haben Operatoren wie &quot;ist gleich einem von&quot; und &quot;ist nicht gleich einem von&quot; bei der Eingabe von Textwerten &quot;Ungültige Eingabe für den Operatortyp&quot; ausgelöst, obwohl Text unterstützt werden sollte. (TGT-52629)
* Es wurden mehrere Probleme behoben, die zu einem inkonsistenten Verhalten im [!UICONTROL Modifications] Bereich der aktualisierten Benutzeroberfläche führten, wenn Angebote mit der Schaltfläche „Angebot auswählen“ ausgewählt wurden. Anstatt das vorhandene Angebot zu ersetzen, hat die Benutzeroberfläche ein Duplikat hinzugefügt und versucht, mit einem der beiden Angebote zu interagieren, was zu Konsolenfehlern wie `selectorNotFound` führte. Darüber hinaus wird bei einigen Angeboten nicht die Schaltfläche „Angebot auswählen“ angezeigt, sondern nur bearbeitbare Eigenschaften. (TGT-53321)
* Es wurde ein Problem in der aktualisierten [!DNL Target]-Benutzeroberfläche behoben, durch das HTML-Codeänderungen, die während der Aktivitätseinrichtung vorgenommen wurden, nicht auf Variationsseiten beibehalten wurden, obwohl sie korrekt für Kontrollgruppen gespeichert wurden. Trotz mehrfacher Versuche und Neuerstellung von Tests ohne Seitengruppierungen konnten die Variationsseiten Änderungen nicht beibehalten, was sich auf die Content-Bereitstellung und die QA-Validierung auswirkte. (TGT-53436)
* Es wurde ein Problem im aktualisierten VEC behoben, bei dem der Operator &quot;entspricht einem der&quot; in den Seitenübermittlungsregeln keine Eingabewerte akzeptiert. Bei der Konfiguration von Kundenparametern für alle Mboxes führte die Auswahl dieses Operators zu einem Fehler „Ungültige Eingabe“, was die Erstellung von Regeln verhinderte. (TGT-52623)
...
* Es wurde ein Problem behoben, bei dem einige Aktivitäten, die vom Frontend von [!DNL Target] zu [!DNL Target] Central migriert wurden, aufgrund eines zuvor behobenen Synchronisierungsfehlers inkonsistente Metrikkonfigurationen hatten. Insbesondere bei Aktivitäten, die ursprünglich eine Konvertierungsmetrik verwendet und später auf eine analysebasierte Metrik aktualisiert wurden, wurden veraltete Werte in den Feldern `primaryMetricType` und `successCriteria` beibehalten. (TGT-52643)
...
* Es wurde ein neuer Migrationsendpunkt implementiert, um die Übertragung gelöschter Aktivitätsoptionen von JCR-basierten Aktivitäten zu [!DNL Target] Central zu unterstützen. Diese Funktion ermöglicht eine systemübergreifende konsistente Verfolgung und Berichterstellung. Diese Funktion stellt sicher, dass gelöschte Optionen im Frontend und Backend von [!DNL Target] beibehalten und synchronisiert werden, wodurch die historische Berichterstellung und die Datenintegrität verbessert werden. (TGT-53217)
* Es wurde ein neuer API-Endpunkt eingeführt, mit dem Benutzer zuvor gelöschte Aktivitätsoptionen aus einer sekundären Datenbank wiederherstellen können. Diese Funktion nutzt die vorhandene Infrastruktur, die von den `RemovedCampaignElements`- und `RemovedOptionInfo`-Klassen bereitgestellt wird, um eine nahtlose Wiedereingliederung gelöschter Optionen in aktive Aktivitäten sicherzustellen. (TGT-52903)
* Es wurde ein Problem behoben, bei dem [!DNL Recommendations] Aktivitäten, die Metriknamen mit mehr als 25 Zeichen enthalten, aufgrund von API-Einschränkungen nicht geöffnet oder bearbeitet werden konnten. Dieser Fix stellt die Kompatibilität mit Metronamen sicher, die die Zeichenbeschränkung überschreiten, und stellt den vollständigen Zugriff auf die betroffenen Aktivitäten wieder her. (TGT-52839)
...
* Es wurde ein Problem behoben, bei dem Benutzer die Aktivität site_cart_z1 [!DNL Recommendation] auf der [!DNL Target]-Benutzeroberfläche nicht bearbeiten konnten. Der Versuch, die Aktivität zu öffnen, hat einen Fehler auf der Seite &quot;[!UICONTROL Overview]&quot; ausgelöst und den Zugriff auf den Editor blockiert. (TGT-53221)
...
* Es wurde ein Problem behoben, bei dem das `contentEditable`-Attribut unbeabsichtigt auf &quot;true&quot; festgelegt wurde und im gespeicherten HTML-Inhalt beibehalten wurde. Dieses Update stellt eine sauberere, erwartete HTML-Ausgabe ohne unbeabsichtigtes Bearbeitungsverhalten sicher. (TGT-52319)
* Um einen dauerhaften Verlust gelöschter Optionen zu verhindern und ein konsistentes Verhalten über Dienste hinweg sicherzustellen, wurde eine Soft-Delete-Funktion für Optionen in der Benutzeroberfläche und den zugehörigen Microservices implementiert.
...
* Fehlerkorrektur - Beim Kopieren einer Aktivität aus einem nicht standardmäßigen in einen standardmäßigen Arbeitsbereich oder zwischen nicht standardmäßigen Arbeitsbereichen tritt jetzt kein Fehler mehr auf. Angebote werden jetzt mit verbessertem Tracking und Benennung dupliziert, um Konflikte zu vermeiden.
  ...
  **Wichtige Verbesserungen**:
   ...
   * Diese Funktion verhindert Fehler, die durch mehrere identische &quot;Offer Copy&quot;-Namen während wiederholter Kopieraktionen verursacht werden.
   * Angebote werden möglicherweise nicht sofort in der Angebotsliste des Arbeitsbereichs &quot;Ziel&quot; angezeigt, sondern entsprechend verarbeitet und angezeigt.

  Dieses Update verbessert die Zuverlässigkeit und Rückverfolgbarkeit bei der Verwaltung von Angeboten über mehrere Arbeitsbereiche hinweg. (TGT-53080)

+++

### [!DNL Target Standard/Premium] 25.7.2 (Samstag, 18. Juli 2025)

Aufgrund der kürzlich festgestellten Probleme, die hauptsächlich komplexe Kundenanpassungen betreffen, enthält diese Version die folgenden Korrekturen und Aktualisierungen:

**Aktivitäten**

+++Weitere Informationen
* Eine zusätzliche Bestätigungswarnung wurde hinzugefügt, wenn Änderungen an Aktivitäten mit nicht gespeicherten Änderungen abgebrochen werden: &quot;Möchten Sie diese Aktivität wirklich speichern? Wenn Sie nicht speichern, gehen alle Ihre Änderungen verloren.&quot; Diese Meldung hilft, versehentlichen Datenverlust zu verhindern. (TGT-52865)
* Die alte Funktionalität wurde auf dem Schieberegler &quot;[!UICONTROL Priority]&quot; in &quot;[!UICONTROL Goals & Settings]&quot; wiederhergestellt, sodass Kunden direkt einen numerischen Wert eingeben können, wie dies in der alten Benutzeroberfläche unterstützt wird. (TGT-53185 und TGT-53219)
...
+++Weitere Informationen
* Es wurde ein Problem behoben, das das Speichern oder Bearbeiten von Aktivitäten mit benutzerdefinierten Zielgruppen verhinderte. Bei Kunden wurde die Fehlermeldung angezeigt &quot;Ihre Anforderung kann nicht abgeschlossen werden. Wenden Sie sich an [!DNL Adobe Client Care], wenn das Problem weiterhin besteht.&quot; wenn Sie versuchen, Änderungen an bestimmten Aktivitäten zu speichern oder sogar ohne Änderungen zu speichern. (TGT-53189)
...
* Es wurde ein Problem behoben, durch das Kunden daran gehindert wurden, eine Aktivität zu erstellen oder zu speichern, wenn [!DNL Adobe Analytics] (A4T) als Berichtsquelle im Schritt [!UICONTROL Goals & Settings] ausgewählt wurde. Das Problem trat speziell bei der Auswahl einer [!UICONTROL Custom Event]-Metrik auf (z. B. „Benutzerspezifisches Ereignis 16„), was zu folgendem Fehler führte: „Ungültige Benutzereingabe“. (TGT-52910)
...
* Fehlerkorrektur - Im Workflow zum Erstellen von Aktivitäten treten jetzt keine Probleme mehr im Zusammenhang mit der Angebotsbenennung und der Inhaltsübersetzung in [!UICONTROL Automated Personalization] Aktivitäten (AP) und [!UICONTROL Multivariate Testing] (MVT) auf:
   ...
   * Das Erstellen mehrerer HTML-Angebote mit demselben Namen (z. B. &quot;Erfahrung&quot;) hat den Fehler &quot;Doppelte Angebotsnamen sind nicht zulässig&quot; ausgelöst, aber die Benutzeroberfläche hat nicht eindeutig angegeben, welche Angebote den Konflikt verursacht haben.
...
* Die Option &quot;[!UICONTROL Rearrange]&quot; wurde der aktualisierten Benutzeroberfläche &quot;[!UICONTROL Visual Experience Composer] (VEC)&quot; hinzugefügt, um sie an die Funktionen anzupassen, die im älteren VEC verfügbar sind. (TGT-46957 und TGT-52876)
...
* Es wurde ein Problem behoben, das verhinderte, dass einige Aktivitätsänderungen im aktualisierten VEC ordnungsgemäß angezeigt wurden. (TGT-52818)
...
* Es wurde ein Problem behoben, bei dem beim Erstellen einer neuen Aktivität durch Klonen einer vorhandenen Aktivität die QA-Links in der geklonten Aktivität die Seiten-URLs aus der ursprünglichen Aktivität fälschlicherweise beibehalten haben. (TGT-52775)
...
* Es wurde ein Problem behoben, das die Bearbeitung einer Aktivität des Produkts &quot;[!DNL Recommendations]&quot; verhinderte. Beim Versuch, über die Ziel-Benutzeroberfläche auf den VEC zuzugreifen, trat auf der Seite [!UICONTROL Overview] ein Fehler auf, der jegliche Änderungen verhinderte. (TGT-52823)
...
* Es wurde ein Problem behoben, bei dem Kunden eine Recommendations-Aktivität nicht speichern konnten, nachdem sie die Kriterien in der neuen Benutzeroberfläche geändert hatten. Das Problem scheint berechtigungsbezogen zu sein und betrifft nicht alle Benutzer mit ähnlichen Rollen. (TGT-52816)
...
* Es wurde ein Problem im aktualisierten VEC behoben, bei dem die Standardinhaltsverarbeitung in [!UICONTROL Automated Personalization] (AP)-Aktivitäten nicht mit der alten Benutzeroberfläche übereinstimmte. Das System fügt jetzt automatisch eine Standardgruppe &quot;`optionGroup`&quot; mit dem Namen &quot;Standardinhalt&quot; mit &quot;`optionGroupLocalId = 0`&quot; hinzu, wenn keine Gruppe explizit hinzugefügt wird. Diese Gruppe umfasst die Standardoption (z. B. `optionLocalId: 0`). Wenn der Standardinhalt entfernt wird, wird auch die entsprechende Optionsgruppe entfernt. (TGT-52651)
...
* Die Validierungsfehlermeldung für [!DNL A/B Test] Aktivitätsupdates über die Back-End-API wurde verbessert. Wenn doppelte Positionsnamen vorhanden sind, wird in der Meldung jetzt eindeutig Folgendes angezeigt: &quot;Doppelte Namen sind nicht zulässig&quot; für `locations.selectors`. (TGT-52589)
...
* Es wurde ein Problem behoben, durch das [!UICONTROL Page Delivery] die Fehlermeldung fälschlicherweise angezeigt hat: &quot;Doppelte Seiten-URLs sind nicht zulässig. (TGT-52765)
* Es wurde ein Problem behoben, durch das Zielgruppen für [!UICONTROL Page Delivery] URLs, die Experience Fragments enthielten, mit # fälschlicherweise angehängt wurden. (TGT-52786)
* Es wurde ein Problem behoben, durch das das Kopieren einer Aktivität und das Bearbeiten von Einstellungen auf der Seite [!UICONTROL Goals and Settings] dazu führte, dass die Benutzeroberfläche von [!DNL Target] nicht mehr reagierte. (TGT-52797)
...
* Es wurde ein Problem behoben, das das Speichern von [!DNL Recommendations] Designs mithilfe von Velocity-Arrays verhinderte. Die Fehlermeldung &quot;Mindestens 1 Entitätsvariable sollte im Skript verwendet werden&quot; wurde falsch ausgelöst. (TGT-52734)
* Es wurde ein Problem behoben, durch das auf Änderungen in [!UICONTROL Visual Experience Composer] (VEC) nicht zugegriffen werden konnte, wenn die Seite nicht für interne Webseiten geladen werden konnte. (TGT-52488 UND TGT-52470)
* Es wurde ein Problem behoben, durch das das Bedienfeld &quot;[!UICONTROL Modifications]&quot; bei kleineren Bildschirmgrößen im VEC nicht sichtbar war. (TGT-52470)
...
* Es wurde ein Problem behoben, das Kunden daran hinderte, Angebote in [!UICONTROL Automated Personalization] (AP)-Aktivitäten zu löschen oder zu entfernen. (TGT-52690)
* Es wurde ein Problem behoben, das zu inkonsistentem Aktivitätsqualifizierungsverhalten bei mehrseitigen Aktivitäten führte. (TGT-52694)
* Es wurde ein Problem behoben, das dazu führte, dass die [!UICONTROL Overview]-Seite der Aktivität eine ungültige URL für [!UICONTROL Activity Location] anzeigte. (TGT-52695)
...
* Es wurde ein Problem behoben, das einen `getAudiencesV3`-Fehler auslöste und Kunden daran hinderte, Aktivitäten zu bearbeiten oder zu kopieren. (TGT-52709)
...
* Es wurde ein Problem behoben, bei dem der aktualisierte Wert &quot;[!UICONTROL Visual Experience Composer] (VEC)&quot; den Wert &quot;`at_property`&quot; nicht automatisch erkannte. (TGT-52347)
* Es wurde ein Problem behoben, das dazu führte, dass zwei Änderungen aufgezeichnet wurden, wenn nur eine erwartet wurde, nachdem zwischen dem Modus &quot;[!UICONTROL Browse]&quot; und dem Modus &quot;[!UICONTROL Design]&quot; im VEC gewechselt wurde, während mit einem Formularelement interagiert wurde. (TGT-52455)
...
* Es wurde ein Problem behoben, bei dem Angebotsaktualisierungen blockiert und fälschlicherweise der Fehler &quot;Ungültiger Benutzer&quot; angezeigt wurde. (TGT-52361)
...
* Es wurde ein Cacheproblem behoben, das das Speichern der Aktivität [Site-Voreinstellungen](/help/main/c-experiences/c-visual-experience-composer/viztarget-options.md#settings) verhinderte. (TGT-52213)
* Es wurde ein Problem behoben, bei dem Kunden die Auswahl nach ID und Klasse im Abschnitt &quot;[!UICONTROL Site Preferences]&quot; nicht aktivieren konnten, nachdem sie die Site in den VEC geladen hatten. Die Einstellung &quot;[!UICONTROL Site Preferences]&quot; wurde auch nach der Aktivierung automatisch auf &quot;Deaktiviert&quot; zurückgesetzt. (TGT-52207)
* Es wurde ein Problem behoben, bei dem die [!UICONTROL Visual Experience Composer]-URL (VEC) nicht die richtige Seite anzeigen konnte, wenn die [Seitenübermittlung](/help/main/c-experiences/c-visual-experience-composer/viztarget-options.md#settings)-URLs mit einem Schrägstrich (/) endeten. (TGT-52237)
...
* Es wurde ein Problem behoben, bei dem das Standardangebot ausgewählt wurde, aber andere Angebotsinhalte in [!UICONTROL Automated Personalization] (AP) und [!UICONTROL Multivariate Test] (MVT) Aktivitäten angezeigt wurden. (TGT-52372)
* Die GET-Berechtigungslogik wurde behoben, um mit OR zwischen vollständigem Organisationszugriff und spezifischem Organisations- + Benutzerzugriff zu prüfen. (TGT-52374)
...
* Es wurde ein Problem behoben, das dazu führte, dass reine Aktivitätszielgruppen von der aktualisierten Benutzeroberfläche verschwanden, nachdem sie eine neue Zielgruppe erstellt und ausgewählt hatten. (TGT=52091)
* Es wurde ein Problem behoben, das die Verwendung doppelter Zielgruppen bei Aktivitäten verhinderte. (TGT-51200 und TGT-52057)
* Es wurde ein Fehler behoben, der dazu führte, dass Zielgruppenverfeinerungen und Aktivitäts-Zielgruppen in der aktualisierten Benutzeroberfläche rückgängig gemacht wurden. (TGT-52158)
...
* Es wurde ein Problem behoben, bei dem [!DNL Target] Kunden nicht warnte, wenn eine Aktivität bearbeitet und ein geändertes Website-Element geändert wurde. (TGT-52100)
* Es wurde ein Problem behoben, durch das beim Bearbeiten eines Angebots mit Ad-hoc-Angeboten ein neues Angebot erstellt wurde, anstatt das vorhandene zu aktualisieren. (TGT-52135)
* Es wurde ein Problem behoben, das einen ungültigen Payload-Fehler beim Verschieben von Angeboten in Ordner verursachte. (TGT-52325)
...
* Für jede Aktivität wurde ein `audienceMetadata`-Feld hinzugefügt und sichergestellt, dass es beim Bearbeiten der Aktivität gelesen und aktualisiert wird. (TGT-51004)

### [!DNL Target Standard/Premium] 25.4.5 (Samstag, 25. April 2025)

Diese Version enthält die folgenden Fehlerbehebungen und Updates:
...
* Es wurde ein Problem behoben, durch das Batch-Vorgänge nach dem Hinzufügen von Regeln für die Seitenübermittlung nicht fehlschlugen. (TGT-52097)
* Es wurde ein Problem behoben, das dazu führte, dass [!DNL Target] alle Abfrageparameter von der URL der Website trimmte. (TGT-52100)
* Es wurde ein Konsolenfehler behoben, der Kunden daran hinderte, Aktivitäten in der älteren und der aktualisierten [!DNL Target]-Benutzeroberfläche zu erstellen. (TGT-52181)
...
* Es wurde ein Problem behoben, das dazu führte, dass Änderungen nicht mehr angezeigt wurden, nachdem zusätzliche Seiten hinzugefügt und dann zurück zur Registerkarte [!UICONTROL Experiences] navigiert wurde. (TGT-52264)
* Es wurde ein Problem behoben, durch das Kunden daran gehindert wurden, die Zielgruppe in einer [!UICONTROL Experience Targeting] (XT)-Aktivität zu ändern. (TGT-52191)
...
* Es wurde ein Problem behoben, durch das Kunden daran gehindert wurden, Aktivitäten in allen Arbeitsbereichen zu erstellen. (TGT-52218)
* Es wurde ein Problem behoben, durch das Änderungen aus einer Erfahrung beim Wechsel zu einer anderen Erfahrung falsch angezeigt wurden. (TGT-52184)
...
Ab dem 22. April 2025 können nur [!UICONTROL Product]- und [!UICONTROL Solutions]-Administratoren die Einstellungen in den [!UICONTROL Administration] Abschnitten aktualisieren, unabhängig von ihrer Rolle in [!DNL Target] Arbeitsbereichen. Benutzer ohne diese Berechtigung haben schreibgeschützten Zugriff auf die [!UICONTROL Administration]-Abschnitte.
...
* Es wurde ein Problem behoben, das das Bearbeiten von Änderungen an den Seitenüberschriften in der aktualisierten [!DNL Target]-Benutzeroberfläche verhinderte. (TGT-51797)
* Es wurde ein Null-Fehler behoben, der beim Duplizieren eines Erlebnisses, Löschen eines anderen Erlebnisses und anschließendem Speichern der Aktivität auftrat. (TGT-51796)
...
* Es wurde ein Problem behoben, bei dem alle Änderungen der Zielgruppe im Status nach dem Abbrechen des Aktivitätserstellungsprozesses entfernt wurden (Auswählen von [!UICONTROL Cancel] anstelle von [!UICONTROL Add Audience]). (TGT-51769 und TGT-51770)
* Es wurde ein Problem behoben, bei dem der [!UICONTROL Visual Experience Composer] (VEC) für einige Aktivitäten nicht geladen werden konnte, insbesondere wenn benutzerdefinierter Code verwendet wurde.  Das Problem führte dazu, dass der VEC einen leeren Bildschirm anzeigte oder die [!DNL Target]-Benutzeroberfläche auf ihre ältere Version zurückgesetzt wurde. (TGT-51758)
...
* Es wurde ein Problem behoben, bei dem durch Klicken auf [!UICONTROL Cancel] beim Bearbeiten einer Aktivität in der Target-Benutzeroberfläche statt auf der [!UICONTROL Activities List] Seite zur [!UICONTROL Activity Details] navigiert wurde. (TGT-51731)
...
Während die [!DNL Adobe Target]-Benutzeroberflächenmodernisierung fortgesetzt wird, freuen wir uns, die allgemeine Verfügbarkeit der aktualisierten [!UICONTROL Activities]-Benutzeroberfläche bekannt geben zu können.
...
* **Einzelaufruf für Personalisierung und Messung.**
  ...
  Ursprünglich empfohlen, wird der Einzelaufrufansatz für [!DNL Platform Web SDK] als zugunsten des Split-Call-Ansatzes veraltet geplant. Adobe berät alle neuen Implementierungen, den neuen Split-Call-Ansatz zu nutzen, und empfiehlt, dass bestehende Kunden auch auf die Split-Call-Methode umsteigen.
...
Weitere Informationen zu at.js-Versionen finden Sie unter [at.js-Versionsdetails](https://experienceleague.adobe.com/de/docs/target-dev/developer/client-side/at-js-implementation/target-atjs-versions){target=_blank} im *Adobe Target-Entwicklerhandbuch*.
...
* Es wurden Probleme behoben, die die Aktivitäten von [!UICONTROL Automated Personalization] (AP) für einige Kunden betrafen, einschließlich der rechtzeitigen Synchronisierung der Aktivität auf dem [!DNL Target]-Backend und der Bereitstellung des erwarteten Erlebnisses bei Vorschaulinks. (TGT-46202)
...
Weitere Informationen finden Sie im [Adobe Target-Entwicklerhandbuch](https://experienceleague.adobe.com/docs/target-dev/developer/implementation/privacy/allowlist-edges.html?lang=de){target=_blank} unter *Kantenknoten für das Ziel zulassen*.
...
* Es wurde ein Problem behoben, das Kunden daran hinderte, den Tastaturfokus zu verwenden, um für [!UICONTROL Goals & Settings] (XT)-Aktivitäten zum nächsten Element auf der [!UICONTROL Experience Targeting] zu wechseln. (TGT-44526)
...
* Leistungsverbesserungen, um doppelte Funktionen zu verhindern (einschließlich einer Verringerung der Ladezeit), während [Ausschlüsse verwaltet werden](/help/main/c-activities/t-automated-personalization/managing-exclusions.md#concept_4EF78013F80E48EFA024AE0274C9F037) in [!UICONTROL Automated Personalization] Aktivitäten.
...
### Real-Time CDP-Profilattribute, die für [!DNL Target] [!UICONTROL Real-Time CDP Profile Attributes] freigegeben wurden (13. Juni 2023)
...
| [*Adobe Target-Entwicklerhandbuch*](https://experienceleague.adobe.com/docs/target-dev/developer/overview.html?lang=de){target=_blank} | Das *Adobe Target-Entwicklerhandbuch* wurde nach *[!UICONTROL Adobe Experience League]* verschoben. Der Wechsel zu *[!UICONTROL Experience League]* hilft bei der Lokalisierung von Text in zusätzlichen Sprachen, vereinheitlicht die Suche in *Experience League*, um Suchergebnisse von *[!UICONTROL Adobe Target Business Practitioner Guide]* und *[!UICONTROL Adobe Target Developer Guide]* zu erfassen und anzubieten, und bietet zusätzliche Vorteile.<P>Sie werden vom vorherigen Speicherort automatisch zu *[!UICONTROL Experience League]* umgeleitet. Bitte aktualisieren Sie Ihre Lesezeichen nach Bedarf. |
...
* Es wurde ein Problem behoben, aufgrund dessen Kundinnen und Kunden nach Auswahl der Option [!UICONTROL A/B Test] unter [!UICONTROL Adobe Analytics] > [!UICONTROL Administration] > [!UICONTROL Reporting] manchmal keine [!UICONTROL Reporting Experience Cloud Solution] Aktivitäten erstellen konnten. (TGT-44844)
...
* Updates für das Authoring benutzerdefinierter Webkomponenten mit [!UICONTROL Visual Experience Composer] (VEC):
...
>[!NOTE]
>
>Um die Bereitstellung der in der VEC erstellten Änderungen sicherzustellen, stellen Sie sicher, dass Sie ein [!DNL Target] SDK ([at.js](https://experienceleague.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/target-atjs-versions.html?lang=de){target=_blank} oder [Adobe Experience Platform Web SDK](https://experienceleague.adobe.com/docs/experience-platform/edge/release-notes.html?lang=de){target=_blank} (alloy.js)) mit einer Version über 2,8 verwenden.
...
Mit der neuen [!DNL Adobe Target]-Modelle-API, auch Blocklisten-API genannt, können Benutzer die Liste der Funktionen anzeigen und verwalten, die in Machine-Learning-Modellen für [!UICONTROL Automated Personalization] (AP)- und [!UICONTROL Auto-Target] (AT)-Aktivitäten verwendet werden.

Weitere Informationen finden Sie unter Übersicht über die [Models-API](https://experienceleague.adobe.com/docs/target-dev/developer/api/models-api/models-api.html?lang=de){target=_blank} im *Adobe Target-Entwicklerhandbuch*.
...
* In der [!DNL Target]-Benutzeroberfläche wurde eine QuickInfo hinzugefügt, die Kunden beim Erstellen oder Bearbeiten einer [!UICONTROL Auto-Target]-Aktivität, die A4T verwendet, bei der Auswahl eines Optimierungskriteriums unterstützt.
...
* Es wurde ein Fehler behoben, der dazu führte, dass eine Fehlermeldung angezeigt wurde, wenn bei der Erstellung einer [!UICONTROL Clicked an Element]-Aktivität (MVT) das Konversionsziel [!UICONTROL Multivariate Testing] ausgewählt wurde. (TGT-43842)
...
* Eine Warnmeldung wird angezeigt, wenn ein Kunde versucht, eine Zielgruppe mit einem Ausrufezeichen ( ! ) als erstes Zeichen im Namen des Publikums (z. B. !London). (TGT-43643)
...
* Es wurde eine Verbesserung für die neue [!UICONTROL Audiences]-Seite bereitgestellt, um einen inkonsistenten Zustand zwischen der alten Datenbank, in der die Zielgruppen in der Vergangenheit gespeichert wurden, und der neuen Architektur, die die Informationen direkt vom Backend abruft, zu verhindern. (TGT-43552)
...
* Es wurde ein Problem behoben, das beim Rendern von [!UICONTROL Offer Decisions] in [!UICONTROL Experience Targeting] (XT)-Aktivitäten zeitweise Zeitüberschreitungen verursachte. (TNT-44611)
...
* Es wurde ein Problem behoben, das verhinderte, dass die Schaltfläche &quot;Kriterien bearbeiten&quot; auf der Seite &quot;[!UICONTROL Experiences]&quot; für [!DNL Recommendations] Aktivitäten im VEC ordnungsgemäß angezeigt wurde. (TGT-39512)
...
* Die angezeigte Benutzeroberflächennachricht wurde um eine zusätzliche Klärung erweitert, wenn ein Kunde versucht, [!DNL Analytics] als Berichtsquelle (A4T) für eine [!UICONTROL Automated Personalization]-Aktivität auszuwählen. In der Meldung wird angegeben, dass &quot;[!DNL Target]&quot; die einzige unterstützte Quelle für [!UICONTROL Automated Personalization]-Aktivitäten ist.&quot; (TGT-41954)
...
| Funktion | Details |
| --- | --- |
| [!UICONTROL Analytics for Target] (A4T) | Durch Klicken auf den Link &quot;[!UICONTROL View in Analytics]&quot; auf der Seite &quot;[!UICONTROL Reports]&quot; aus einer Aktivität, die [!DNL Analytics] als Berichtsquelle verwendet (A4T), wird [!DNL Analysis Workspace] jetzt geöffnet. Zuvor wurden durch den Link die Berichte von [!DNL Analytics] geöffnet. (TGT-36959) |
...
* Es wurde ein Problem behoben, das das ordnungsgemäße Laden der Seite [!UICONTROL Administration] > [!UICONTROL Scene7 configuration] verhinderte. (TGT-39918)
...
* [!UICONTROL Personalization Insights] Berichte für [!UICONTROL Auto-Target] (AT) und [!UICONTROL Automated Personalization] (AP) werden jetzt täglich erstellt. Sie können einen Bericht auswählen, der [!UICONTROL Automated Segments] oder [!UICONTROL Important Attributes] für die letzten 15, 30 und 60 Tage bereitstellt. Die Optionen für 45 und 90 Tage wurden entfernt, damit die anderen Einstellungen des Lookback-Fensters täglich ausgeführt werden können. (TGT-39472)
* Es wurde ein Problem behoben, das dazu führte, dass die aktuelle Abhängigkeit nicht angezeigt wurde, wenn Kunden auf der [!UICONTROL Edit Dependency] einer Aktivität auf [!UICONTROL Goals & Settings] klicken. (TGT-39340)
...
* Dem [!UICONTROL Last Updated]-[!UICONTROL Recommendations] wurde ein [!UICONTROL Catalog Search] Filter hinzugefügt. (TGT-38340)
* Es wurde ein Problem in [!UICONTROL Recommendations] behoben, das dazu führte, dass die Seite [!UICONTROL Create Sequence] nach dem Ändern der Branchennormalen hängte. (TGT-38160)
...
* Es wurde ein Problem in [!UICONTROL Experience Targeting] (XT)-Aktivitäten behoben, das dazu führte, dass Erlebnisse über einen längeren Zeitraum &quot;Abrufergebnisse&quot; anzeigten. (TGT-37684)
...
#### Aktualisierung der Benutzeroberfläche des Abschnitts &quot;[!UICONTROL Administration]&quot;

Derzeit wird die gesamte Benutzeroberfläche von [!DNL Target] schrittweise mittels eines neuen Technologie-Stacks umgeschrieben. Dadurch wird eine verbesserte Leistung, eine Verkürzung der Wartungszeit bei der Veröffentlichung neuer Funktionen und ein optimiertes Benutzererlebnis im gesamten Produkt angestrebt. Der erste aktualisierte Abschnitt ist der Abschnitt [!UICONTROL Setup], der umbenannt wurde [!UICONTROL Administration].

Im Rahmen dieser Aktualisierung können Sie viele Aktionen mithilfe der Seiten im Abschnitt &quot;[!UICONTROL Administration]&quot; durchführen, z. B.:

* Laden Sie die neueste Datei at.js von der Registerkarte [!UICONTROL Implementation] herunter (**[!UICONTROL Administration]** > **[!UICONTROL Implementation]**).
* Passen Sie Ihre at.js-Einstellungen an und können Sie Ihre Änderungen ganz einfach überprüfen (**[!UICONTROL Administration]** > **[!UICONTROL Implementation]**).
* Erweiterte Berichterstellungseinstellungen wie Standardwährung und Zeitzone, IPs, die von der Berichterstellung ausgeschlossen werden sollen, usw. ändern (**[!UICONTROL Administration]** > **[!UICONTROL Reporting]**)
* Verdecken Sie Besucher-IP-Adressen aus Datenschutzgründen (**[!UICONTROL Administration]** > **[!UICONTROL Implementation]**)
* Zeigen Sie die bestehende Benutzerliste pro Arbeitsbereich und ihre Rollen an, bevor Sie sie in Adobe Admin Console verwalten (**[!UICONTROL Administration]** > **[!UICONTROL Users]**).
...
* Es wurde ein Problem behoben, das verhinderte, dass [!UICONTROL Insert After] > [!UICONTROL Image] mit SVG-Bildern (Scalable Vector Graphics) ordnungsgemäß funktionierte. (TGT-37242)
...
| Benachrichtigungen senden | Ermöglicht es Entwicklern, Benachrichtigungen zu senden, wenn ein Erlebnis durch ihren Code statt durch die Verwendung von `applyOffer()` oder `applyOffers()` gerendert wird.<br>Weitere Informationen finden Sie unter [adobe.target.sendNotifications(options)](https://experienceleague.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/functions-overview/adobe-target-sendnotifications-atjs-21.html?lang=de){target=_blank}. |
...
* Nachdem Sie eine [!UICONTROL Recommendations] Sammlung aus der Sammlungsauswahl ausgewählt haben, müssen Sie jetzt auf die Schaltfläche [!UICONTROL Save] klicken. Dieser Workflow ist konsistent mit anderen Workflows innerhalb von [!DNL Target]. (TGT-33205)
...
* Die Sicherungszeile des Recommendations CSV-Downloads enthält jetzt einen vorangestellten &quot;&#42;&quot; (doppelte Anführungszeichen, die ein Sternchen enthalten) anstelle von &quot;&#42;&quot; (ein einzelnes Sternchen).
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Zuvor war in Target eine Abhängigkeit für eine einzelne Metrik zulässig, und diese Metrik musste erreicht werden, bevor die zugehörige Anzahl inkrementiert wurde. Sie können nun für mehrere Metriken eine Abhängigkeit bereitstellen und die flexible Auswahl ermöglichen, ob die Metrik erreicht werden soll oder nicht, damit die Anzahl inkrementiert wird. </p> <p>Die Abhängigkeitsfunktionalität für mehrere Metriken wird ab sofort für Folgendes unterstützt: </p> <p> 
     <ul id="ul_EC856F910B704D648065EA7DA13EE5B0"> 
      ...
      <li id="li_E3A983A70BB04AE8B25A7CEC1F5FE1D9"> <p>Der Metriktyp "Seite angezeigt". </p> </li> 
...
* Die Benutzererfahrung in [!UICONTROL Visual Experience Composer] (VEC) beim Auswählen von auszublendenden Elementen wurde verbessert.
(TGT-22224)
* Die Benutzererfahrung beim Erstellen von Aktivitäten mit [!UICONTROL Form-Based Experience Composer] wurde verbessert. Wenn Sie einen mbox-Speicherort auswählen, bleibt der Validierungsrahmen hervorgehoben, nachdem Sie auf &quot;[!UICONTROL Next]&quot; geklickt haben. (TGT-22221)
...
* Mit Version 48 von Chrome trat ein Problem auf, das dazu führte, dass Visual Experience Composer in Chrome nicht richtig funktionierte. Google arbeitet bereits an einer Lösung. Weitere Informationen erhalten Sie unter [https://code.google.com/p/chromium/issues/detail?id=582603](https://code.google.com/p/chromium/issues/detail?id=582603). So umgehen Sie das Problem:
   ...
   * Aktivieren Sie den Enhanced Experience Composer, der über die Registerkarte **[!UICONTROL Administration]** > **[!UICONTROL Visual Experience Composer]** konfiguriert werden kann.
...
| Funktion | Beschreibung |
|---|---|
| Targeting von Aktivitätseinträgen nach Prozentsatz | Sie können jetzt Einträge in [A/B](/help/main/c-activities/t-test-ab/t-test-create-ab/test-create-ab.md)- und [multivariate](/help/main/c-activities/c-multivariate-testing/t-create-multivariate-test/create-multivariate-test.md#task_BF870FA60A8245AB8F0B775BE32EA710)-Aktivitäten auf einen bestimmten Prozentsatz von Besuchern oder Zielgruppenmitgliedern beschränken. Beispiel: Sie können Einträge auf 50 % aller Besucher oder 45 % der Zielgruppe aus Kalifornien begrenzen. |
...
* Es wurde ein Problem behoben, bei dem ausgewählte Links nicht als ausgewählt markiert wurden, wenn Benutzer auf der **[!UICONTROL Select Link]** Seite auf [!UICONTROL Goals and Settings] klickten.
