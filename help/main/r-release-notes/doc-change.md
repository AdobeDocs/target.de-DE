...
| --- | --- | --- |
| 22. August | [Die Benutzeroberfläche von  [!DNL Target] ](/help/main/c-intro/understand-the-target-ui.md) | Es wurden Informationen zu Benachrichtigungen hinzugefügt, wenn eine [!DNL Recommendations] Feed schlägt fehl. |
