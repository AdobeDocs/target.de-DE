...
| --- | --- | --- |
| 9. April | [Fehlerbehebung bei Problemen im Zusammenhang mit [!UICONTROL Visual Experience Composer]](/help/main/c-experiences/c-visual-experience-composer/r-troubleshoot-composer/troubleshooting-issues-related-to-the-visual-experience-composer-vec.md) | Der folgende Abschnitt wurde aktualisiert:<ul><li>Meine Seite wird im VEC nicht angezeigt (nur VEC) </li></ul>Der folgende neue Abschnitt wurde hinzugefügt:<ul><li>Probleme, die durch CSS-Konflikte im [!UICONTROL Visual Experience Composer]</li></ul> |
|  | [Berichte zu Personalization Insights](/help/main/c-reports/c-personalization-insights-reports/personalization-insights-reports.md) | Der Abschnitt „Überlegungen“ wurde aktualisiert. |
| 22. März | [Zulassungsliste für Target-Edge-Knoten](https://experienceleague.adobe.com/en/docs/target-dev/developer/implementation/privacy/allowlist-edges){target=_blank} | Die Verweise auf die Edge-Knoten 31 bis 38 wurden entfernt, da diese Knoten nicht mehr vorhanden sind. Stellen Sie sicher, dass Ihre Zulassungsliste aktuell ist. |
|  | [Auswirkungen der Einstellung von Drittanbieter-Cookies auf Target (at.js)](https://experienceleague.adobe.com/docs/target-dev/assets/third_party_cookie_deprecation){target=_blank} | Neuer Blogpost, der beschreibt, was die geplante Einstellung von Drittanbieter-Cookies durch Google für Ihre Organisation bedeutet [!DNL Adobe Target] at.js-Implementierung. |
| 14. März | [[!DNL Target] Versionshinweise (aktuell)](/help/main/r-release-notes/release-notes.md) | Versionshinweise für hinzugefügt [!DNL Adobe Experience Platform Visual Editing Helper] für [!DNL Google Chrome]. |
| 13. März | [[!UICONTROL Time Frame]](/help/main/c-target/c-audiences/c-target-rules/time-frame.md) | Es wurden Informationen hinzugefügt, die darauf hinweisen, dass zeitbasierte Zielgruppen erneut gespeichert werden, um die Sommerzeit zu berücksichtigen. |
| 6. März | [Browser](/help/main/c-target/c-audiences/c-target-rules/browser.md) | Die Informationen im folgenden Abschnitt wurden aktualisiert: „Aktualisierungen für [!DNL iPad] und [!DNL iPhone] in [!UICONTROL Browser] Zielgruppenattribute (30. April 2024)„. |
|  | [Target-Versionshinweise (aktuell)](/help/main/r-release-notes/release-notes.md) | Der gesamte Abschnitt „Aktualisierungen für“ wurde aktualisiert. `Browser:iPad` und `Browser:iPhone` in [!UICONTROL Browser] Zielgruppenattribute (30. April 2024)„. |
...
| Datum | Thema | Änderungen |
| --- | --- | --- |
| 28. Februar | [[!DNL Target] Versionshinweise (Vorabversion)](/help/main/r-release-notes/target-release-notes.md) | Es wurden Informationen zur hinzugefügt [!DNL Target] Standard/Premium 24.3.1 (4.-6. März 2024). |
| 26. Februar | [[!DNL Adobe Target] Ankündigungen und Ereignisse](/help/main/r-release-notes/target-announcements.md) | Es wurden Informationen über bevorstehende hinzugefügt [!UICONTROL Adobe Target Community] Kaffeepause (28. Februar 2024). |
| 23. Februar | [Von verwendete IP-Adressen [!DNL Recommendations] feed-processing servers](/help/main/c-recommendations/c-recommendations-faq/ip-addresses-marketing-cloud.md) | Auf die Zulassungsliste setzen Der folgende wichtige Hinweis und neue IP-Adressen wurden hinzugefügt, die Sie ändern sollten.<P>**Wichtig**: Die [!DNL Target] -Team aktualisiert derzeit die NAT-Gateway-Adressen zum Herunterladen [!DNL Recommendations] Feeds. Wenn Sie die IP-Zulassungsauflistung auf die Zulassungsliste setzte implementieren, stellen Sie sicher, dass Sie die folgenden neuen AWS-Hosts hinzufügen. Die vorhandenen Hosts sollen am 30. Juni 2024 eingestellt werden. Um einen reibungslosen Übergang zu gewährleisten, sollten alle neun Adressen auf die Zulassungsliste gesetzt werden. Es ist nicht dringend erforderlich, die vorhandenen Adressen zu entfernen. |
...
| 5. Februar | [Erstellen einer Aktivität mit Analytics als Berichtsquelle](/help/main/c-integrating-target-with-mac/a4t/campaign-creation.md) | Text wurde hinzugefügt, der angibt, dass bei Verwendung von nicht derselbe Aktivitätsname für zwei Aktivitäten aus separaten Arbeitsbereichen verwendet werden kann [!UICONTROL Analytics for Target] (A4T) als Berichtsquelle. |
|  | [Aktivitätseinstellungen – Häufig gestellte Fragen zu A4T](/help/main/c-integrating-target-with-mac/a4t/r-a4t-faq/a4t-faq-activity-setup.md) | Text wurde hinzugefügt, der angibt, dass bei Verwendung von nicht derselbe Aktivitätsname für zwei Aktivitäten aus separaten Arbeitsbereichen verwendet werden kann [!UICONTROL Analytics for Target] (A4T) als Berichtsquelle. |
...
| 22. Januar | [Target-Versionshinweise (aktuell)](/help/main/r-release-notes/release-notes.md) | Es wurden wichtige Informationen zur Einstellung von iPad und iPhone aus dem hinzugefügt [!UICONTROL Browser] Zielgruppenattribut, das vor dem 30. April 2024 Änderungen Ihrerseits erfordert. |
...
| Datum | Thema | Änderungen |
| --- | --- | --- |
| 18. Januar | [[!DNL Target] Versionshinweise (Vorabversion)](/help/main/r-release-notes/target-release-notes.md) | Vorab-Versionshinweise für die Version [!DNL Target Standard/Premium] 24.1.1 hinzugefügt. |
...
| 29. November | [API zur stapelweisen Aktualisierung](https://experienceleague.adobe.com/docs/target-dev/developer/implementation/methods/bulk-profile-update-api.html?lang=de){target=_blank} | Es wurden die Unterschiede in Bezug auf Folgendes klargestellt [!DNL Target] Verarbeitet Kundenattribute beim Erstellen eines Profils für einen Benutzer [!DNL Target] hat bei Verwendung von noch nicht angezeigt [!UICONTROL Bulk Profile Update API] v2 im Gegensatz zu v1. |
...
| 17. November | [Erste Schritte für Admins](/help/main/administrating-target/start-target.md) | Folgender wichtiger Hinweis wurde hinzugefügt:<ul><li>Benutzende mit [!UICONTROL Product Admin] oder [!UICONTROL System Admin] Rechte in der [!DNL Adobe Admin Console] Kann alle Einstellungen auf der Seite bearbeiten oder ändern [!UICONTROL Administration] Seite von [!DNL Target], unabhängig von [!DNL Target] Rolle. Benutzer ohne [!UICONTROL Product Admin] oder [!UICONTROL System Admin] Rechte in der [!DNL Adobe Admin Console] muss Folgendes enthalten [!DNL Target] Rolle für diese Änderungen.1</li></ul> |
...
| Datum | Thema | Änderungen |
| --- | --- | --- |
| 10. November | [Recommendations-API-Referenz](https://developer.adobe.com/target/administer/recommendations-api/){target=_blank} | Die [!DNL Recommendations]-API von [!DNL Adobe Target] wurde zur [!DNL Adobe Developer]-Website verlegt. Bitte aktualisieren Sie Ihre Lesezeichen nach Bedarf. |
|  | [Zeitrahmen](/help/main/c-target/c-audiences/c-target-rules/time-frame.md) | Es wurde ein Hinweis hinzugefügt, dass Zielgruppen der [!DNL Target]-Zeit die Umstellung auf Sommerzeit nicht unterstützen. Sie müssen Zielgruppen manuell aktualisieren, um Sommerzeit-Änderungen Rechnung zu tragen. |
| 8. November | [[!DNL Target] Versionshinweise (Vorabversion)](/help/main/r-release-notes/target-release-notes.md) | Vorab-Versionshinweise für die Version [!DNL Target Standard/Premium] 23.11.1 hinzugefügt. |
...
| 25. Oktober | [[!DNL Target] Versionshinweise (aktuell)](/help/main/r-release-notes/release-notes.md) | Es wurden Informationen zur hinzugefügt [!UICONTROL Activities] Aktualisierung der Seiten-Benutzeroberfläche (25. Oktober 2023) |
| 24. Oktober | [Target-Versionshinweise (aktuell)](/help/main/r-release-notes/release-notes.md) | Versionshinweise für die Version 23.10.2 von [!DNL Target Standard/Premium] hinzugefügt. |

## [!DNL Target] Standard/Premium 23.9.1 (6.–11. September 2023)

| Datum | Thema | Änderungen |
| --- | --- | --- |
| 17. Oktober | [Häufig gestellte Fragen zum Reporting](/help/main/c-reports/reporting-frequently-asked-questions.md#section_E4722F6445884130951DF79981C8289B) | Die folgenden FAQ wurden aktualisiert: „Warum stehen für meinen Aktivitätsbericht keine Daten zur Verfügung? “ |
| 11. Oktober | [[!DNL Adobe Analytics] fungiert als Berichtsquelle für  [!DNL Adobe Target]  (A4T)](/help/main/c-integrating-target-with-mac/a4t/a4t.md#section_F487896214BF4803AF78C552EF1669AA) | Informationen zur A4T-Unterstützung für das [!DNL Adobe Experience Platform Web SDK]. |
...
|  | [Einrichten von A4T-Berichten in [!DNL Analysis Workspace] für [!UICONTROL Auto-Allocate] Aktivitäten](https://experienceleague.adobe.com/docs/target-learn/tutorials/integrations/set-up-a4t-reports-in-analysis-workspace-for-auto-allocate-activities.html?lang=de){target=_blank} | Das gesamte Tutorial wurde in der *[!UICONTROL Adobe Target Tutorials]* Handbuch. |
...
|  | [Initialisieren des Java SDK](https://experienceleague.adobe.com/docs/target-dev/developer/server-side/java/initialize-sdk.html?lang=de){target=_blank} | Die folgenden neuen Parameter wurden zur Tabelle hinzugefügt:<ul><li>`connectionTtlMs`</li><li>`idleConnectionValidationMs`</li><li>`evictIdleConnectionsAfterSecs`</li></ul> |
| 22. September | [Fehlerbehebung bei Problemen im Zusammenhang mit [!UICONTROL Enhanced Experience Composer]](/help/main/c-experiences/c-visual-experience-composer/r-troubleshoot-composer/troubleshooting-issues-related-to-the-enhanced-experience-composer-eec.md#section_D29E96911D5C401889B5EACE267F13CF) | Die Liste der IP-Adressen wurde auf die Zulassungsliste aktualisiert. |
...
| Datum | Thema | Änderungen |
| --- | --- | --- |
| 1. September | [Umgebungen](/help/main/administrating-target/environments.md##section_4F8539B07C0C45E886E8525C344D5FB0) | Aktualisierter Hinweis unter „Festlegen der Standardumgebung für das Reporting“. |
| 30. August | [Datenschutz](https://experienceleague.adobe.com/docs/target-dev/developer/implementation/privacy/privacy.html?lang=de#aep){target=_blank} | Neuer Abschnitt hinzugefügt: „IP-Verschleierung auf Datenstromebene bei Verwendung des Adobe Experience Platform Web SDK“ |
|  | [Aktivitätseinstellungen – Häufig gestellte Fragen zu A4T](/help/main/c-integrating-target-with-mac/a4t/r-a4t-faq/a4t-faq-activity-setup.md#section_9F8092BE4225442896F926540292F221) | Der Zeitrahmen wurde korrigiert, sodass Daten in Berichten in den folgenden häufig gestellten Fragen angezeigt werden: „Ich habe gerade eine Aktivität erstellt. Warum sehe ich keine eingehenden Daten?&quot; |
| 29. August | [Unterstützte Funktionen für die geräteinterne Entscheidungsfindung](https://experienceleague.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/on-device-decisioning/supported-features.html?lang=de){target=_blank} | Die Liste der Geo-Attribute wurde hinzugefügt, die für das Targeting bei Client-seitiger Verwendung von On-Device Decisioning (ODD) auf dem Gerät unterstützt werden. |
|  | [Übersicht über On-device Decisioning](https://experienceleague.adobe.com/docs/target-dev/developer/server-side/on-device-decisioning/overview.html?lang=de){target=_blank} | Die Liste der Geo-Attribute wurde hinzugefügt, die für das Targeting bei Server-seitiger Verwendung von On-Device Decisioning (ODD) auf dem Gerät unterstützt werden. |
...
|  | [[!DNL Adobe Target] Ankündigungen und Ereignisse](/help/main/r-release-notes/target-announcements.md) | Es wurden Informationen über die bevorstehende Adobe Target Community-Kaffeepause (30. August 2023) hinzugefügt: Webinar-Nachbereitung „Strategize for maximum ROI impact with peak season readiness“. |
...
|  | [Angebote](/help/main/c-experiences/c-manage-content/manage-content.md) | Es wurde ein Hinweis hinzugefügt, der erklärt, dass Bildangebote nicht Teil des [!UICONTROL Enterprise User Permissions] Modell. |
| 9. August | [Mobile Target-Vorschau](https://experienceleague.adobe.com/docs/target-dev/developer/mobile-apps/target-mobile-preview.html?lang=de){target=_blank} | Das Thema wurde mit Informationen zu den aktuellen Versionen des [!DNL Adobe Experience Platform Mobile SDK] aktualisiert. |
| 9. August | [Mobile Target-Vorschau](https://experienceleague.adobe.com/docs/target-dev/developer/mobile-apps/target-mobile-preview.html?lang=de){target=_blank} | Das Thema wurde mit Informationen zu den aktuellen Versionen des [!DNL Adobe Experience Platform Mobile SDK] aktualisiert. |
|  | [[!DNL Adobe Target] Ankündigungen und Ereignisse](/help/main/r-release-notes/target-announcements.md) | Es wurden Informationen über das folgende Webinar hinzugefügt, das für den 17. August 2023 geplant ist: *Strategize for maximum ROI impact with peak season readiness*. |
