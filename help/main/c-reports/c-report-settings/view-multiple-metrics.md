...
* Sie können die Option [Herunterladen](/help/main/c-reports/c-report-settings/downloading-data-in-csv-file.md) nicht verwenden, um Berichte in CSV herunterzuladen, wenn Sie mehrere Metriken ausgewählt haben. Zum Aktivieren der Option [!UICONTROL Download] dürfen Sie nur eine einzelne Metrik auswählen.
...
1. (Bedingt) Beim Anzeigen des Berichts in der [!UICONTROL Diagrammansicht] können Sie einzelne Metriken aus der Dropdown-Liste auswählen, die angezeigt werden sollen.
