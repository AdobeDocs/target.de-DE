...
1. Klicken Sie neben **[!UICONTROL Zielvorgabe]** auf das Symbol **[!UICONTROL Weitere Optionen]** ( ![Symbol Weitere Optionen](/help/main/assets/icons/MoreSmallListVert.svg) ) > **[!UICONTROL Als neu speichern]**.

   Das [!UICONTROL Voreinstellung erstellen] wird angezeigt.

   ![Dialogfeld für neue Voreinstellung](/help/main/c-reports/c-report-settings/assets/report_preset_dialog-new.png)

1. Überprüfen Sie die Informationen in den **[!UICONTROL Filtern]**, um sicherzustellen, dass der Bericht wie gewünscht konfiguriert ist, und geben Sie dann den **[!UICONTROL Vorgabenamen]** (bis zu 50 Zeichen) an.
1. (Bedingt) Wenn Sie dies als Standard-/Favoritenansicht verwenden möchten, schieben Sie den Umschalter **[!UICONTROL Als Standardvorgabe festlegen]** auf „Ein“.
...
1. Bearbeiten Sie die Berichtskonfiguration wie gewünscht (Metriken, Datumsbereiche, Zielgruppen, erweiterte Einstellungen usw.).
   ...
   Nachdem Sie auf [!UICONTROL Speichern] geklickt haben, nachdem Sie die Berichtskonfiguration bearbeitet haben, wird nach dem Namen der Vorgabe ein Sternchen ( &#42; ) angezeigt, um anzugeben, dass die Vorgabe geändert wurde.

1. Klicken Sie auf **[!UICONTROL Weitere Optionen]** ( ![Symbol Weitere Optionen](/help/main/assets/icons/MoreSmallListVert.svg) ) > **[!UICONTROL Als neu speichern]**, um eine neue Vorgabe zu erstellen.

### Löschen einer Vorgabe

1. Wählen Sie die Voreinstellung aus, die Sie löschen möchten.
1. Klicken Sie auf das Symbol **[!UICONTROL Weitere Optionen]** ( ![Symbol Weitere Optionen](/help/main/assets/icons/MoreSmallListVert.svg) ) > **[!UICONTROL Löschen]**.

1. Klicken Sie **[!UICONTROL erneut auf]** Löschen“, um das Löschen zu bestätigen (gelöschte Vorgaben können nicht wiederhergestellt werden).
...
## [!UICONTROL Berichtsmetrik] {#section_894ABD7148244806B7CE556EBBA2AD62}

Klicken Sie auf **[!UICONTROL Berichtsmetrik]** Dropdown-Liste, um eine andere [Erfolgsmetrik](/help/main/c-activities/r-success-metrics/success-metrics.md#reference_D011575C85DA48E989A244593D9B9924) oder mehrere Metriken auszuwählen, die im Diagramm angezeigt werden sollen.
...
## [!UICONTROL Zielgruppe] {#section_70926EB4618945D9AFF2B0564FF3717B}

Klicken Sie auf **[!UICONTROL Dropdown]** Liste „Zielgruppe“, um die angezeigte Zielgruppe für den Bericht zu ändern.

Weitere Informationen finden Sie unter [Zielgruppen](/help/main/c-target/target.md#concept_A782F8481A5041EBA75103CB26376522).

## [!UICONTROL Vorgegebener Datumsbereich]

Klicken Sie auf **[!UICONTROL Dropdown-Liste]** Vorgegebener Datumsbereich“, um aus vordefinierten Datumsbereichen auszuwählen.

Wählen Sie neue **[!UICONTROL Start-]** und **[!UICONTROL Enddaten]** für den Bericht aus. Sie können auch die Bereiche **[!UICONTROL Beginn der Aktivität]** und **[!UICONTROL Beginn der Aktivität - Ende der Aktivität]** verwenden.
...
Das [!UICONTROL Datumsbereich] zeigt den aktuellen Datumsbereich des Berichts an. Klicken Sie auf **[!UICONTROL Kalender]** ( ![Kalendersymbol](/help/main/assets/icons/Calendar.svg) ), um einen Kalender anzuzeigen, in dem Sie den Datumsbereich des Berichts ändern können.

## Einstellungen {#section_D99CE462107D45CABE0960F820E1E972}

So konfigurieren Sie Berichteinstellungen:

1. Klicken Sie auf **[!UICONTROL Berichteinstellungen]** ( ![Berichteinstellungen-Symbol](/help/main/assets/icons/Setting.svg) ) und nehmen Sie die gewünschten Änderungen vor (wie unten beschrieben).
...
Klicken Sie [!UICONTROL Berichtsdaten zurücksetzen]. Berichtsdaten zurücksetzen, um alte Daten zu entfernen. Aktuelle Besucher verbleiben in der Aktivität.  Diese Option steht nur Personen mit „Genehmiger[!UICONTROL -] zur Verfügung.
...
Der Umschalter [!UICONTROL Extreme Werte ausschließen] gilt nur für Aktivitäten mit den Metriktypen Umsatz und Interaktion. Weitere Informationen finden Sie unter [Ausschließen extremer Bestellungen](/help/main/c-reports/c-report-settings/excluding-extreme-orders.md#task_2AE7743FFCDD466DAEEB720BE5F33DAA).

## Download {#section_77E65C50BAAF4AB79242DB3A8778ADEF}

Klicken Sie auf **[!UICONTROL Herunterladen]** ( ![Herunterladen-Symbol](/help/main/assets/icons/Download.svg) ), um Berichtsdaten in einem [!DNL .csv] Format für den schnellen Import in Excel, Access oder andere Datenanalyseprogramme herunterzuladen.
...
Klicken Sie auf **[!UICONTROL Aktualisieren]** ( ![Aktualisierungssymbol](/help/main/assets/icons/Refresh.svg) ), um die Tabellen- und Diagrammansicht eines Berichts zu aktualisieren, ohne die gesamte Seite, ihre Konfiguration oder ihren Datumsbereich zu aktualisieren.

## Weitere Optionen {#section_AB1B5C695D7045A0A0AC0E2698D2E7DE}

Klicken Sie auf das Symbol **[!UICONTROL Weitere Optionen]** ( ![Symbol Weitere Optionen](/help/main/assets/icons/MoreSmallListVert.svg) ), um auf die [!UICONTROL Als neu speichern] und [!UICONTROL Löschen] zuzugreifen.
...
* Nur beim Anzeigen von Berichten in [!UICONTROL Tabellenansicht] verfügbar.
...
Klicken Sie auf das Symbol [[!UICONTROL Location Contribution]](/help/main/c-reports/multivariate-test-reports/location-contribution-report.md) ( ![Location Contribution-Symbol](/help/main/assets/icons/LocationContribution.svg) ), um den Bericht so umzuschalten, dass der Beitrag für Aktivitäten des Typs Multivariater Test (MVT) nach Standort angezeigt wird.

## Erlebnisse {#section_3A450DE1FA7E43F0AAB73165EC3D1C34}

Nur verfügbar, wenn der Bericht in der [!UICONTROL Diagrammansicht] angezeigt wird.
...
Um auf die Option [!UICONTROL Zählmethodik] zuzugreifen, während Sie einen Bericht im Diagrammmodus anzeigen, klicken Sie auf die **[!UICONTROL Mein Primäres Ziel]** und wählen Sie dann die Zählmethodik aus.
...
Es gibt vier Modi für [!UICONTROL automatische Targeting]-Aktivitäten: [!UICONTROL Tägliche Kontrolle], [!UICONTROL Tägliches Targeting], [!UICONTROL Kumulative Kontrolle] und [!UICONTROL Kumulatives Targeting].

Die Standardreihenfolge, in der das Diagramm gezeichnet wird, lautet wie folgt:

* **[!UICONTROL A/B]Test) (einschließlich [!UICONTROL Automatische Zuordnung] und [!UICONTROL Automated Personalization])**: Reihenfolge der Erlebniserstellung, in absteigender Reihenfolge.
* **[!UICONTROL Erlebnis-Targeting] (XT)**: Reihenfolge der Erlebnisse in der Aktivität.
* **[!UICONTROL Multivarianz-Test] (MVT)**: Alphabetisch nach Erlebnisname.
* **[!UICONTROL Recommendations]**: Reihenfolge der Erlebniserstellung in absteigender Reihenfolge.

Beachten Sie bei der Arbeit mit den [!UICONTROL Zählmethodik]-Optionen die folgenden Einschränkungen:

* Bei [[!UICONTROL automatischen Targeting]-Aktivitäten](/help/main/c-activities/auto-target/auto-target-to-optimize.md) gibt es keine Option zur Auswahl von „Besuchern“ als Zählmethodik. [!UICONTROL Automatisches Targeting] ist der einzige Aktivitätstyp, den Sie nicht nach Besuchern grafisch darstellen können.
