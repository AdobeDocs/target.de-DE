...
>[!NOTE]
>
>Beachten Sie bei der Arbeit mit dem Bericht [!UICONTROL Standortbeitrag] die folgenden Informationen:
>
>* Die Zielgruppen- und Metrikauswahl sind nur verfügbar, wenn [!DNL Analytics] als Berichtsquelle (A4T) verwendet wird.
>
>* Daten für den Bericht [!UICONTROL Standortbeitrag] werden auch dann aus dem [!DNL Target]-Backend abgerufen, wenn die Aktivität für die Verwendung von [!UICONTROL Analytics als Berichtsquelle] (A4T) konfiguriert ist.
>
>* Daten für den [!UICONTROL Standortbeitrag]-Bericht werden für die „Produktionsumgebung“ abgerufen, auch wenn auf der Ebene des [!DNL Target]-Kontos eine andere Standardumgebung definiert ist.

Der [!UICONTROL Standortbeitrag] enthält zwei Tabellen.
