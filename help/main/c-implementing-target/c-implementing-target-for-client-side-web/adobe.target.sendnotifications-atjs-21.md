...
description: Verwenden Sie adobe.target.sendNotifications() für at.js, um Benachrichtigungen an die [!DNL Target] Edge, wenn ein Erlebnis nicht mit applyOffer(s) gerendert wird. (at.js.2.1 +)
