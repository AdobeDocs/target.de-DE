---
keywords: Implementierung;JavaScript-Bibliothek;js;at.js;on-device Decisioning;bei Geräteentscheidungen;Regel-Artefakt
description: Erfahren Sie mehr über das JSON-Regelartefakt, das von der Entscheidungsfindung auf dem Gerät verwendet wird.
...
Das Regelartefakt ist eine JSON-Darstellung Ihrer [!DNL Adobe Target] Entscheidungsaktivitäten auf dem Gerät. Das Regelartefakt wird von [!DNL Target] und an das Akamai-CDN weitergeleitet werden, um sicherzustellen, dass Ihren Besuchern ein Regelartefakt so nah wie möglich zur Verfügung steht. Das Regelartefakt enthält Metadaten, die die präzise Ausführung und Bereitstellung Ihrer Aktivitäten sicherstellen und gleichzeitig Echtzeitanalysen über das Ereignis-Tracking ermöglichen.

Dies ist ein Beispiel für ein JSON-Regel-Artefakt:
