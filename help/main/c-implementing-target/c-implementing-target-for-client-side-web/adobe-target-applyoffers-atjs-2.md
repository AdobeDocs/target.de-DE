...
>[!NOTE]
>
>Lesen Sie die [Dokumentation zur Bereitstellungs-API](https://developer.adobe.com/target/before-administer/){target=_blank} für Informationen zu den akzeptablen Typen für alle unten aufgeführten Felder.
