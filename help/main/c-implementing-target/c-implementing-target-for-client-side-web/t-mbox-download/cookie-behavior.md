...
Siehe auch [Löschen des Target-Cookies](https://developer.adobe.com/target/before-implement/privacy/cookie-deleting/){target=_blank}.
...
## Auswirkungen auf [!DNL Target] für Safari-Besucher aufgrund von Tracking-Änderungen in Apple WebKit {#section_2A2E5730ED7D4A0985C904AFEA310AAE}

**Wie funktioniert [!DNL Adobe Target] Tracking-Arbeit?**
