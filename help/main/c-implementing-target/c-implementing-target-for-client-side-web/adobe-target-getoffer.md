...
description: Verwenden Sie die Funktion adobe.target.getOffer() und ihre Optionen für die Adobe [!DNL Target] at.js-Bibliothek , um Anforderungen zum Abrufen einer [!DNL Target] Angebot.
title: Wie verwende ich die Funktion adobe.target.getOffer()?
feature: at.js
role: Developer
...
| Zeitüberschreitung | Nummer | Nein | Zeitüberschreitung in Millisekunden Wird kein Wert festgelegt, kommt der Standardwert für die Zeitüberschreitung in at.js zum Einsatz.<br>Die standardmäßige Zeitüberschreitung kann über die [!DNL Target] Benutzeroberfläche unter [!UICONTROL Administration > Implementierung]. |
