...
Sie müssen die Arbeitsbereichs-ID übergeben, um Unternehmensberechtigungen in nutzen zu können. [Target-APIs](https://developer.adobe.com/target/implement/server-side/){target=_blank}.
