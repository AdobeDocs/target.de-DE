...
title: Welche Profile, Variablen und Parameter werden in [!DNL Target] verwendet?
feature: Audiences
...
| user.getLocal(&#39;param_name&#39;); | Rufen Sie den Wert ab, den Sie mit `user.setLocal` festgelegt haben. |
...
| profile.mobile.isTablet | Besuchergerät ist ein Tablet.<P>**HINWEIS**: Dieses Profil ersetzt die veraltete Browserkategorie &quot;iPad-Zielgruppe&quot;. Weitere Informationen finden Sie unter [Browser](/help/main/c-target/c-audiences/c-target-rules/browser.md#profile-scripts) . |
| profile.mobile.isMobilePhone | Besuchergerät ist ein Mobiltelefon.<P>**HINWEIS**: Dieses Profil ersetzt die veraltete Browserkategorie &quot;iPhone-Zielgruppe&quot;. Weitere Informationen finden Sie unter [Browser](/help/main/c-target/c-audiences/c-target-rules/browser.md#profile-scripts) . |
