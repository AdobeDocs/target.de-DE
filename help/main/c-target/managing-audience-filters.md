...
description: Erfahren Sie, wie Sie in [!DNL Adobe Target] Zielgruppenfilter verwenden können, um Daten von Besuchern anzuzeigen, die Eigenschaften teilen.
...
* **Aus der Liste [!UICONTROL Audiences] erstellte Zielgruppen können wiederverwendet werden.** Zielgruppen, die als Teil einer Aktivität erstellt werden, können nicht wiederverwendet werden.
