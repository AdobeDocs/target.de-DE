...
description: Lernen Sie die Grundlagen der Adobe kennen [!DNL Target] Standard und Adobe [!DNL Target] Premium. [!DNL Target] Premium umfasst erweiterte Funktionen, die nicht im Standardprodukt verfügbar sind.
...
[Recommendations als Angebot](/help/main/c-recommendations/recommendations-as-an-offer.md) ermöglicht Ihnen die Integration von Recommendations in die Aktivitäten von [!UICONTROL A/B-Tests], [!UICONTROL automatischer Zuordnung], [!UICONTROL automatischem Targeting] und [!UICONTROL Erlebnis-Targeting] (XT).
