...
1. Klicken Sie auf der Seite Aktivitätsübersicht auf die drei vertikalen Punkte und dann auf **[!UICONTROL Erlebnis-URLs anzeigen]**.

1. Überprüfen bzw. geben Sie Ihre URLs an.

   * Bei Verwendung von [!UICONTROL Visual Experience Composer] (VEC) wird die für die Aktivität angegebene Standard-URL automatisch eingegeben und für jedes Erlebnis in der Aktivität wird ein Link generiert. Sie können diese URL nach Wunsch ändern oder weitere hinzufügen.
   * Wenn Sie den [!UICONTROL formularbasierten Experience Composer] verwenden, wird automatisch keine Standard-URL eingegeben. Wenn Sie noch keine Erlebnisvorschau-URLs erstellt haben, klicken Sie auf **Neue URL hinzufügen**. Sie müssen alle URLs, für die Sie eine Vorschau anzeigen möchten, sowie einen Namen für jede URL angeben.
...
1. Klicken Sie auf **[!UICONTROL Alle generieren]** und dann auf jedes Erlebnis, um eine Vorschau anzuzeigen.
...
1. Klicken Sie **[!UICONTROL Fertig]**, um zur Aktivitätsübersicht zurückzukehren.
