...
1. (Bedingt) Um ein oder mehrere Erlebnisse aus der Aktivität auszuschließen, klicken Sie auf das Symbol **[!UICONTROL Ausschließen]**.
   ...
   Um mehrere Erlebnisse auszuschließen, aktivieren Sie die Kontrollkästchen für die gewünschten Erlebnisse und klicken Sie dann oben rechts in der Liste **[!UICONTROL das Symbol]** Ausschließen“.

   Standardmäßig sind alle Erlebnisse in der Aktivität [!UICONTROL Automated Personalization] enthalten. Um ein ausgeschlossenes Erlebnis einzuschließen, bewegen Sie den Mauszeiger über das Erlebnis und klicken Sie auf das Symbol **[!UICONTROL Einschließen]**.

   Um mehrere ausgeschlossene Erlebnisse einzubeziehen, aktivieren Sie die Kontrollkästchen für die gewünschten Erlebnisse und klicken Sie dann oben rechts in der Liste auf **[!UICONTROL Einschließen]**-Symbol.

1. Klicken Sie auf **[!UICONTROL Erstellen]**, um zum [!UICONTROL Visual Experience Composer] zurückzukehren, um weitere Änderungen vorzunehmen, oder klicken Sie auf **[!UICONTROL Weiter]**, um zum Schritt [!UICONTROL Targeting] zu wechseln.
