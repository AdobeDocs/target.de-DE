...
description: Verwalten von Ausschlüssen in AP-Aktivitäten (0)[!UICONTROL Automated Personalization]
...
1. Klicken Sie beim Erstellen oder Bearbeiten einer AP-Aktivität auf das Symbol **[!UICONTROL Manage Content]** ( ![Symbol Inhalt verwalten](/help/main/assets/icons/Experience.svg) ).[](/help/main/c-activities/t-automated-personalization/create-ap-activity.md)

   Das Dialogfeld [!UICONTROL Manage Content] wird angezeigt.

1. Klicken Sie auf die Registerkarte **[!UICONTROL Experiences]** .
