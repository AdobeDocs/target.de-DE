...
description: Erfahren Sie, wie Sie die Seite "Ziele und Einstellungen"in Adobe verwenden. [!DNL Target] um Informationen über die Ziele einer Erlebnis-Targeting-Aktivität (XT) anzugeben.
...
# Ziele und Einstellungen in Erlebnis-Targeting-Aktivitäten (XT)
...
![Seite „Aktivitätseinstellungen“](/help/main/c-activities/t-experience-target/t-xt-create/assets/ab_settings-new.png)
...
Wenn diese Option in Administration nicht aktiviert ist (Standardeinstellung), geben Sie eine Priorität an: Niedrig, Mittel oder Hoch.

Um genauer unterteilte Prioritäten festzulegen, klicken Sie auf **[!UICONTROL Administration]** > **[!UICONTROL Berichterstellung]** und stellen Sie dann die Option Präzise Prioritätensetzung aktivieren auf die Position &quot;Ein&quot;.
...
Geben Sie an, ob die Daten von Adobe Target oder Adobe Analytics erfasst werden. Informationen über die Unterschiede zwischen den Berichterstellungslösungen und deren jeweilige Vorteile finden Sie unter [Adobe Analytics als Berichterstellungsquelle für Target](/help/main/c-integrating-target-with-mac/a4t/a4t.md).
