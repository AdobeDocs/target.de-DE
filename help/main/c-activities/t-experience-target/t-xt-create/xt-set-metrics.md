...
description: Erfahren Sie, wie Sie in einer  [!DNL Adobe Target] [!UICONTROL Experience Targeting] -Aktivität Metriken angeben, um zu ermitteln, wann ein Besuch erfolgreich war, z. B. [!UICONTROL Conversion], [!UICONTROL Revenue] oder [!UICONTROL Engagement].
title: Wie lege ich Zielmetriken in einer [!UICONTROL Experience Targeting] -Aktivität fest?
...
Verwenden Sie Metriken in einer [!DNL Adobe Target] [!UICONTROL Experience Targeting] -Aktivität (XT), um festzustellen, wann ein Besuch erfolgreich war.
