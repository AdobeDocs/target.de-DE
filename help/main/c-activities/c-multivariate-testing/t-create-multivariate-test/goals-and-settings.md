...
description: Erfahren Sie, wie Sie die Seite "Ziele und Einstellungen"in Adobe verwenden. [!DNL Target] um Informationen über die Ziele einer Multivarianz-Test-Aktivität (MVT) anzugeben.
...
Auf der Seite &quot;Ziele und Einstellungen&quot;in Adobe Target geben Sie Informationen zu den Zielen Ihrer [!UICONTROL Multivarianz] (MVT)-Tests.
...
Wenn diese Option in S nicht aktiviert ist[!UICONTROL Administration] > [!UICONTROL Berichterstellung] (Standardeinstellung), geben Sie eine Priorität an: Niedrig, Mittel oder Hoch.
