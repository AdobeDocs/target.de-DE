...
description: Erfahren Sie, wie Sie Multivariate Testing (MVT) im Adobe verwenden. [!DNL Target] um Angebotskombinationen in Elementen auf einer Seite zu vergleichen, um zu bestimmen, welche Kombination die beste Leistung erzielt.
