...
[!UICONTROL Aktivitäts-QA] ermöglicht es Ihnen, Ihre [!DNL Target] Aktivitäten vollständig zu testen, bevor Sie sie live starten. Die [!UICONTROL Aktivitäts-QA] umfasst:
...
* Die Fähigkeit, einen QA-Bericht der gesamten User Journey zu erstellen. Mit dem QA-Link können Sie einmal auf Ihre Site zugreifen und die gesamte Site in Aktivitäts-QA durchsuchen. Sie verbleiben in Aktivitäts-QA, bis Sie die Sitzung beenden oder bis Sie die [QA-Zielbookmarklet](/help/main/c-activities/c-activity-qa/activity-qa-bookmark.md#concept_A8A3551A4B5342079AFEED5ECF93E879) verwenden, um sich selbst aus der [!UICONTROL Aktivitäts-QA] zu entfernen. Diese Funktion ist nützlich, wenn Sie eine Aktivität haben, die mehrere Web-Seiten umfasst.

  >[!NOTE]
  >
  >Diese Funktion gilt für at.js-Implementierungen mit Version 2.*x* oder höher. Bei at.js 1.*x*-Implementierungen gilt diese Funktion nur, wenn der Browser des Besuchers keine Cookies von Drittanbietern blockiert.

## Zugreifen auf und Freigeben einer QA-URL {#section_1C59BAA247B247BDB125D1BE8EAD4547}

1. Klicken Sie auf der Seite [!UICONTROL Übersicht] einer Aktivität auf **[!UICONTROL Aktivitäts-QA]**.

1. Konfigurieren Sie die folgenden Einstellungen:

   * **[!UICONTROL Regeln für das Abgleichen von Zielgruppen, um Erlebnisse anzuzeigen]:** Manchmal möchten Sie bestätigen, dass der Abgleich Ihrer Zielgruppen funktioniert. Andernfalls möchten Sie das Erscheinungsbild der Aktivität überprüfen. Wenn sich diese Einstellung in der Stellung „ein“ befindet, müssen Tester die Targeting-Anforderungen erfüllen, um sich für die Anzeige der Erlebnisse zu qualifizieren. Für Erlebnis-Targeting (XT)-Aktivitäten wird eine einzelne Aktivitäts-URL bereitgestellt. Das angezeigte Erlebnis richtet sich danach, ob Sie sich für eine der Targeting-Regeln qualifizieren.
...
1. Geben Sie die Aktivitäts-Link-URLs zum Testen für Mitglieder Ihrer Organisation frei.
   ...
   Aktivitäts-Links laufen nie ab und Sie müssen keine Links erneut senden, wenn jemand eine Aktivität oder ein Erlebnis ändert. Wenn Sie jedoch eine andere Zielgruppe als die [!UICONTROL Zielgruppenbibliothek“ anwenden] anstatt die Aktivität einfach zu bearbeiten, wird ein neuer Link generiert, den Sie erneut freigeben müssen.
   ...
   Sie können auf der Site navigieren, um die anderen Seiten anzuzeigen, da der [!UICONTROL Aktivitäts-QA]-Modus beibehalten wird. Dies gilt für at.js-Implementierungen mit Version 2.*x* oder höher. Bei at.js 1.*x*-Implementierungen ist dies nur der Fall, wenn der Browser des Besuchers keine Third-Party-Cookies blockiert.

1. Um Berichte anzuzeigen, die anhand von Aktivitäts-Link-URLs generiert wurden, klicken Sie auf die Seite **[!UICONTROL Berichte]** der Aktivität, klicken Sie auf das **[!UICONTROL Einstellungen]**-Symbol ( ![icon_gear-](assets/icon_gear.png) ) und wählen Sie dann **[!UICONTROL QA-Modus Traffic]** aus der Dropdown-Liste **[!UICONTROL Umgebung]** aus.

## Beenden des QA-Modus

[!UICONTROL Aktivitäts-QA] bleibt erhalten. Nachdem Sie eine Website in [!UICONTROL Aktivitäts-QA] durchsucht haben, muss Ihre [!DNL Target] abgelaufen sein, oder Sie müssen Sie [!DNL Target] von [!UICONTROL Aktivitäts-QA] entlassen haben, bevor Sie Ihre Website wie einen typischen Besucher anzeigen können.

### at.js 2.*x*

Wenn auf Ihrer Site at.js 2.*x* bereitgestellt ist, verwenden Sie die [Target QA Bookmarklet](/help/main/c-activities/c-activity-qa/activity-qa-bookmark.md#concept_A8A3551A4B5342079AFEED5ECF93E879), um sich selbst aus [!UICONTROL Aktivitäts-QA] zu entfernen. Wenn Sie, wie im nächsten Aufzählungszeichen beschrieben, eine Seite mit einem leeren Wert auf Ihrer Site laden, wird *nicht* das QA-Cookie aus dem Browser entfernt, wenn at.js 2.*x* bereitgestellt wird.

### at.js 1.*x*

Wenn auf Ihrer Site at.js 1.*x* bereitgestellt ist, können Sie zusätzlich zur Verwendung der [Target-QA-Lesezeichenliste](/help/main/c-activities/c-activity-qa/activity-qa-bookmark.md#concept_A8A3551A4B5342079AFEED5ECF93E879) auch manuell eine Abmeldung erzwingen, indem Sie eine Seite auf Ihrer Site mit dem `at_preview_token`-Parameter und einem leeren Wert laden. Beispiel:

`https://www.mysite.com/?at_preview_token=`

### [!DNL Adobe Experience Platform Web SDK]

Wenn auf Ihrer Site [[!UICONTROL Platform Web SDK]](https://experienceleague.adobe.com/docs/target-dev/developer/client-side/aep-web-sdk.html?lang=de){target=_blank} bereitgestellt ist, können Sie sich manuell selbst aus dem System entfernen, indem Sie eine Seite auf Ihrer Site laden, die den `at_qa_mode` Parameter mit einem leeren Wert enthält. Beispiel:
...
In der folgenden Tabelle sind die verschiedenen Aktivitätstypen aufgeführt und angegeben, ob [!UICONTROL Aktivitäts-QA]Modus für jede Bibliothek unterstützt wird:
