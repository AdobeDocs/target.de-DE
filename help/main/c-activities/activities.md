...
| Aktion | Beschreibung |
| --- | --- |
| [!UICONTROL Bearbeiten] | Aktivität ändern. Es kann jede Aktivität bearbeitet werden.<P>Weitere Informationen zu den verschiedenen Methoden zum Bearbeiten von Aktivitäten finden Sie unter [Bearbeiten einer Aktivität oder Speichern als Entwurf](/help/main/c-activities/edit-activity.md). |
