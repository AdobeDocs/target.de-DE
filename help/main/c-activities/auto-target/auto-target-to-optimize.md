...
description: Erfahren Sie, wie eine [!UICONTROL Auto-Target] -Aktivität in  [!DNL Target]  jedem Besucher basierend auf Kundenprofilen und dem Verhalten ähnlicher Besucher das am besten angepasste Erlebnis bereitstellt.
...
Um den Prozentsatz von [!UICONTROL Control] anzupassen, klicken Sie auf die Symbole in der Spalte [!UICONTROL Allocation] . Sie dürfen die Kontrollgruppe nicht auf weniger als 10 % reduzieren.
...
* In Zukunft werden wir mit diesem Testbett die Plattform [!DNL Adobe] für maschinelles Lernen für datenbewusste Kunden öffnen können, damit diese ihre eigenen Modelle einbringen können, um die Modelle [!DNL Target] zu ergänzen.
...
In diesem Video wird beschrieben, wie Sie eine A/B-Aktivität vom Typ [!UICONTROL Auto-Target] einrichten.

Nach Abschluss dieser Schulung sollten Sie zu Folgendem in der Lage sein:

* Definieren von [!UICONTROL Auto-Target]-Tests
* Vergleichen und Kontrahieren von [!UICONTROL Auto-Target] mit [!UICONTROL Automated Personalization]
* Erstellen von [!UICONTROL Auto-Target] -Aktivitäten
