...
description: Erfahren Sie, wie Sie auf der Seite [!UICONTROL Goals and Settings] Informationen zu den Zielen einer A/B-Aktivität angeben.
...
Im Abschnitt [!UICONTROL Advanced Settings] der Seite [!UICONTROL Goals & Settings] können Sie die folgenden Optionen konfigurieren:

Um erweiterte Einstellungen vorzunehmen, klicken Sie auf das Symbol **[!UICONTROL More]** (das vertikale Auslassungszeichen) und dann auf **[!UICONTROL Advanced Settings]**, wie in der folgenden Abbildung dargestellt.
