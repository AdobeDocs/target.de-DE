...
Um auf die Optionen [!UICONTROL Erweiterte Einstellungen] zuzugreifen, klicken Sie auf **[!UICONTROL Vertikale Auslassungszeichen]** > **[!UICONTROL Erweiterte Einstellungen]**.
...
| [!UICONTROL Anzahl erhöhen, Benutzer freigeben und erneuten Eintritt erlauben] | Auswahl des Erlebnisses, das der Besucher bei erneuter Teilnahme an der Aktivität sieht:<ul><li>Gleiches Erlebnis (Standard)</li><li>Ein zufällig ausgewähltes Erlebnis</li><li>Ein noch nicht gesehenes Erlebnis</li></ul> |
