...
- [Target für mobile Apps](https://developer.adobe.com/target/implement/mobile/){target=_blank}: Erklärt, wie [!DNL Target] kann für die Optimierung und Personalisierung mobiler Apps verwendet werden.
