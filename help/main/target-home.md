...
**Letzte Änderung: 12. Januar 2023 ([Hier finden Sie die Änderungen](r-release-notes/doc-change.md))**
...
- [Target für mobile Apps](https://developer.adobe.com/target/implement/mobile/){target=_blank}: Erläutert, wie [!DNL Target] für die Optimierung und Personalisierung mobiler Apps verwendet werden kann.
