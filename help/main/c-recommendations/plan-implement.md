...
[!DNL Target Recommendations] erfordert, dass Sie die [!DNL Adobe Experience Platform Web SDK] oder at.js 0.9.2 (oder höher). Siehe [Implementierung [!DNL Target]](/help/main/c-implementing-target/implementing-target.md) für weitere Informationen.
...
| --- | --- | --- | --- |
| Katalog-Feed | einen Feed planen (CSV, Google Product XML oder [!DNL Analytics Product Classifications]), die täglich hochgeladen und aufgenommen werden. | Zum Senden von Informationen über mehrere Elemente gleichzeitig. Zum Senden von Informationen, die sich selten ändern. | Siehe [Feeds](/help/main/c-recommendations/c-products/feeds.md). |
...
Weitere Informationen finden Sie unter [!UICONTROL Warenkorbbasiert] Empfehlungen, siehe [Warenkorbbasiert](/help/main/c-recommendations/c-algorithms/base-the-recommendation-on-a-recommendation-key.md#cart-based) in *Stützen der Empfehlung auf einen Empfehlungsschlüssel*.
...
Wenn ein Kaufereignis eintritt, geben Sie die Identität des/der gekauften Artikel weiter. Siehe [Konversions-Tracking](/help/main/c-implementing-target/c-implementing-target-for-client-side-web/how-to-deployatjs/implementing-target-without-a-tag-manager.md#task_E85D2F64FEB84201A594F2288FABF053) in *Implementierung [!DNL Target] ohne Tag-Manager*.

## Konfigurieren globaler Ausnahmen {#exclusions}

Schließen Sie alle Elemente auf globaler Ebene aus, die Sie einem Besucher nie empfehlen möchten. Siehe [Ausnahmen](/help/main/c-recommendations/c-products/exclusions.md).
