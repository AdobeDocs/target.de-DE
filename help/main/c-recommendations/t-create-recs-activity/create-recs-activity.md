...
1. Geben Sie eine Aktivitäts-URL an und klicken Sie dann auf **[!UICONTROL Erstellen]**.
   ...
   Wenn Sie auf [!UICONTROL Erstellen] klicken, wird der VEC geöffnet und Ihre Seite angezeigt. Sie können ein aktuelles Element durch Empfehlungen ersetzen oder Empfehlungen einfügen.
