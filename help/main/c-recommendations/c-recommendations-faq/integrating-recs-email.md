...
Weitere Informationen finden Sie in der [Dokumentation zur Bereitstellungs-API](https://experienceleague.adobe.com/docs/target-dev/developer/api/delivery-api/overview.html).{target=_blank}
