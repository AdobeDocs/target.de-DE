...
1. Legen Sie den **[!UICONTROL Lookback Window]** fest, um den Zeitraum der verfügbaren historischen Benutzerverhaltensdaten zu bestimmen, die bei der Bestimmung der anzuzeigenden Empfehlungen verwendet werden sollen. Diese Option ist für alle Algorithmen verfügbar, mit Ausnahme von Elementen mit ähnlichen Attributen und benutzerspezifischen Algorithmen.
...
>[!NOTE]
>
>Wenn Sie **[!UICONTROL Item-Based]**/ **[!UICONTROL Media with Similar Attributes]** als Algorithmustyp und Algorithmus ausgewählt haben, können Sie Regeln zur Ähnlichkeit von Inhalten festlegen.
...
![Bild zur Ähnlichkeit von Inhalten](assets/ContentSimilarity.png)
