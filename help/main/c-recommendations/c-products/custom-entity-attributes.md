...
Siehe [Dokumentation zur Adobe Recommendations API](https://developers.adobetarget.com/api/recommendations) für Informationen zur Verwendung der APIs für die Bereitstellung und Speicherung von Entitäten.
