...
description: Erfahren Sie, wie Feeds Entitäten in Adobe importieren [!DNL Target] Recommendations mit CSV-Dateien, dem Google Product Search-Feed-Format und Analytics-Produktklassifizierungen.
...
Feeds ermöglichen es Ihnen, [Entitäten](/help/main/c-recommendations/c-products/products.md) weiterzugeben oder Ihre Mbox-Daten mit Informationen zu ergänzen, die auf der Seite nicht verfügbar sind oder nicht sicher von der Seite gesendet werden können, wie z. B. Marge, COGS usw.
...
>[!IMPORTANT]
>
>Vor dem Import von Entitätsdaten in [!DNL Recommendations] Beachten Sie bei Verwendung von Analytics-Produktklassifizierungen, dass dies nicht die bevorzugte Methode ist.
>
...
1. Wählen Sie einen **[!UICONTROL Quelltyp]** aus.
   ...
   * Analytics-Classifications
   ...
   Informationen zu den Feed-Typen CSV und Google-Produkt-Feed finden Sie unter [Feeds-Übersicht](/help/main/c-recommendations/c-products/feeds.md#concept_D1E9C7347C5D4583AA69B02E79607890). Sie können auch [CSV-Leitfaden für ein Modell herunterladen](/help/main/c-recommendations/c-products/assets/EntityFileUploadTemplate.csv) , damit Sie den Feed korrekt formatieren können.
...
>[!IMPORTANT]
>
>Hochgeladene Entitäten laufen nach 61 Tagen ab. Das bedeutet, dass Ihre Feed-Datei mindestens alle 60 Tage hochgeladen werden sollte, um eine Unterbrechung Ihrer Empfehlungsaktivitäten zu vermeiden. Wenn ein Element nicht mindestens alle 60 Tage in einer Feed-Datei (oder einer anderen Methode zur Aktualisierung der Entität) enthalten ist, [!DNL Adobe Target] weist darauf hin, dass das Element nicht mehr relevant ist, und entfernt es aus dem Katalog.
