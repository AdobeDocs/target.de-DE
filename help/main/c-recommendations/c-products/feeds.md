...
Die Verwendung des CSV-Formats hat gegenüber dem [!DNL Google]-Feed-Format die folgenden Vorteile:
...
Im Folgenden finden Sie Beispiel-Code für eine [!DNL Google Product Search] Feed-TSV-Datei:
