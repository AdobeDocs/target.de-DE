...
Um auf die Seite [!UICONTROL Katalogsuche] zuzugreifen, klicken Sie auf **[!UICONTROL Recommendations]** > **[!UICONTROL Katalogsuche]**.
...
1. Geben Sie einen Suchbegriff in das Feld **[!UICONTROL Produkte]**.
...
1. Sie können auch Filter verwenden, um das gewünschte Produkt zu finden. Im folgenden Beispiel werden durch Erweitern der Facette [!UICONTROL Sammlungen] und Auswahl von „Bike Tools“ alle Bike Tools in Ihrem Katalog angezeigt.
...
Sie können [!UICONTROL Erweiterte Suche] verwenden, um Ihre Suchergebnisse weiter zu verfeinern oder Ihre Suchergebnisse als [Sammlung](/help/main/c-recommendations/c-products/collections.md) oder [Ausschluss](/help/main/c-recommendations/c-products/exclusions.md) zu speichern.

1. Klicken Sie auf den **[!UICONTROL Erweiterte Suche]**.
...
1. (Optional) Klicken Sie auf **[!UICONTROL Speichern unter]** und anschließend auf **[!UICONTROL Sammlung]** oder **[!UICONTROL Ausschluss]**.
...
1. Klicken Sie **[!UICONTROL Aus Katalog entfernen]**.
...
Sie können [Sammlungen](/help/main/c-recommendations/c-products/collections.md) oder [Ausschlüsse](/help/main/c-recommendations/c-products/exclusions.md) mithilfe von [!UICONTROL Erweiterte Suche] auf der Seite [!UICONTROL Katalogsuche] erstellen ([!UICONTROL Recommendations] > [!UICONTROL Katalogsuche] > [!UICONTROL Erweiterte Suche]).

1. Führen Sie eine [erweiterte Suche](#advanced-search) durch.

1. Klicken Sie **[!UICONTROL Speichern unter]** und dann auf **[!UICONTROL Sammlung]** oder **[!UICONTROL Ausschluss]**.

   ![Als Optionen speichern](/help/main/c-recommendations/c-products/assets/save-as.png)

   >[!IMPORTANT]
   >
   >Bei der [!UICONTROL erweiterten Suche] wird nicht zwischen Groß- und Kleinschreibung unterschieden. Bei Produkten, die zum Zeitpunkt des Versands zurückgegeben werden, wird jedoch zwischen Groß- und Kleinschreibung unterschieden. Diese Diskrepanz kann zu Verwirrung führen. Achten Sie beim Erstellen von Sammlungen oder Ausschlüssen auf der Grundlage von Ergebnissen mithilfe der Funktion [!UICONTROL Erweiterte Suche] auf die Groß-/Kleinschreibung. Wenn Sie z. B. nach „Urlaub“ suchen, werden bei der ersten Suche die Ergebnisse mit „Urlaub“ und „urlaub“ aufgelistet. Wenn Sie dann einen Katalog mit der Absicht erstellen, Produkte mit dem Zusatz „urlaub“ auszugeben, werden nur Produkte mit dem Zusatz „urlaub“ ausgegeben. Produkte, die „Urlaub“ enthalten, werden nicht angezeigt. Ausschlüsse werden in ähnlicher Weise gehandhabt.
...
1. Wählen Sie die gewünschten Suchfacetten (ID, Name, Nachricht usw.) aus und klicken Sie dann auf **[!UICONTROL Speichern]**.
...
1. Klicken Sie auf den **[!UICONTROL Spalten]**.

   ![Spaltenoptionen](/help/main/c-recommendations/c-products/assets/columns.png)

1. (Bedingt) Um die Reihenfolge der aktiven Spalten neu anzuordnen, ziehen Sie die Spalten per Drag-and **[!UICONTROL Drop in den Abschnitt]** Aktive Spalten“ in der gewünschten Reihenfolge.

1. (Bedingt) Ziehen Sie Elemente aus den **[!UICONTROL aktiven Spalten]** nach **[!UICONTROL inaktiven Spalten]** (und umgekehrt).
