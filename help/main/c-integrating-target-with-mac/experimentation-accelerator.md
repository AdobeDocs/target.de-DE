---
keywords: Experimentationsbeschleuniger;Target Workspace;Sandbox-Zuweisung;Adobe Journey Optimizer;Integrationen
description: Erfahren Sie, wie Sie Adobe Target-Arbeitsbereiche Experimentation Accelerator-Sandboxes zuordnen, damit Teams Experimente aus Adobe Target und Adobe Journey Optimizer an einem Ort sehen können.
title: Wie integriere ich  [!DNL Target]  Experimentation Accelerator?
...
Bevor Sie Sandbox-Zuweisungen einrichten, überprüfen Sie, ob Sie über die erforderlichen Berechtigungen verfügen. Um auf **[!UICONTROL Administration]** in Experimentation Accelerator zugreifen zu können, müssen Sie über die Berechtigung **[!UICONTROL Manage configuration]** verfügen.

Benutzer können Sandboxes nur dann [!DNL Target] Arbeitsbereiche zuweisen, wenn beide Bedingungen erfüllt sind:

* Der Benutzer verfügt über die Berechtigung **[!UICONTROL Manage configuration]** in Experimentation Accelerator.
...
1. Klicken Sie auf **[!UICONTROL Save]** , um Ihre Änderungen anzuwenden.
