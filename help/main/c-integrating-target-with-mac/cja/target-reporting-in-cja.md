...
>
>* Wenn Sie [!UICONTROL Use a CJA Metric] als Zielmetrik der Aktivität ausgewählt haben, können Sie mit dieser Option später Ihre Erfolgsmetrik definieren. Da eine [!DNL Customer Journey Analytics] Erfolgsmetrik erst beim Konfigurieren des [!UICONTROL Experimentation]-Bedienfelds ausgewählt wurde, kann ein vordefinierter Bericht nicht im Voraus verfügbar sein, da [!DNL Customer Journey Analytics] nicht wüsste, mit welcher Metrik die Konversionsraten berechnet und von welcher Metrik die Steigerung ausgehen soll.
