...
+ [Handbuch für Adobe Target-Unternehmensfachleute - Startseite](target-home.md)
+ Target-Versionshinweise {#release-notes}
   + {hide-from-toc}[Target-Ankündigungen und -Ereignisse](/help/main/r-release-notes/target-announcements.md)
...
+ Verwaltung von Target {#administer}
   ...
   + [Konfigurieren des Visual Experience Composer](/help/main/administrating-target/visual-experience-composer-set-up.md)
   ...
   + [Geteilte URLs](administrating-target/allowlisted-urls.md)
...
+ Adobe Target MCP-Server {#mcp}
   + [Überblick](c-integrating-target-with-mac/mcp/target-mcp.md)
   + [Erste Schritte](c-integrating-target-with-mac/mcp/target-mcp-get-started.md)
   + [Anwendungsbeispiele und exemplarische Vorgehensweisen](c-integrating-target-with-mac/mcp/target-mcp-use-cases.md)
   + [MCP Server Tools-Referenz](c-integrating-target-with-mac/mcp/target-mcp-tools-reference.md)
+ Integration von Target mit Experience Cloud {#integrate}
   ...
   + Integration von Target mit Adobe Journey Optimizer (AJO) {#ajo}
      ...
      + {hide-from-toc}[Integrieren [!DNL Adobe Target Recommendations] und [!DNL Adobe Journey Optimizer]](/help/main/c-integrating-target-with-mac/ajo/recs-ajo-integration.md)
      + Adobe Journey Optimizer-Anwendungsfälle {#use-cases}
         + {hide-from-toc}[Top-Anwendungsfälle für die Optimierung in Adobe Journey Optimizer - Web- und Code-basierte Kanäle](/help/main/c-integrating-target-with-mac/ajo/top-ajo-use-cases.md)
         + {hide-from-toc}[Inhaltsänderungen durch A/B-Tests in Adobe Journey Optimizer](/help/main/c-integrating-target-with-mac/ajo/content-change-using-ajo.md)
         + {hide-from-toc}[Komponenten zu einer Web-Seite hinzufügen oder ausblenden](/help/main/c-integrating-target-with-mac/ajo/add-hide-content-using-ajo.md)
   + [Integration von Target mit Experimentation Accelerator](/help/main/c-integrating-target-with-mac/experimentation-accelerator.md)
   ...
   + [Integration von Target mit Adobe Audience Manager (AAM)](/help/main/c-integrating-target-with-mac/audience-manager-target-integration.md)
...
+ Aktivitäten {#activities}
   ...
   + Automatisches Targeting {#auto-target}
      ...
      + [Automatisches Targeting - Häufig gestellte Fragen und Fehlerbehebung](/help/main/c-activities/auto-target/auto-target-troubleshooting-faqs.md)
...
+ Berichte {#reports}
   ...
   + Multivarianz-Testberichte {#multivariate-test-reports}
...
+ Recommendations {#recommendations}
   ...
   + Aktivität {#recommendations-activity}
      ...
      + {hide-from-toc}[Vorschau und Starten Ihrer Recommendations-Aktivität](/help/main/c-recommendations/t-create-recs-activity/previewing-and-launching-your-recommendations-activity.md)
   + [Empfehlungen als Angebot](c-recommendations/recommendations-as-an-offer.md)
