...
>[!IMPORTANT]
>
>Ab dem 1. März 2020 unterstützt Adobe Target keine TLS 1.1-Verschlüsselung mehr für Visual Experience Composer (VEC), Enhanced Experience Composer (EEC), Aktivitätsbereitstellung, APIs usw. Bitte aktualisieren Sie vor dem 1. März 2002 auf TLS 1.2, um Probleme zu vermeiden.
...
Bislang wurde für [Enhanced Experience Composer](../../c-experiences/experiences.md#section_34265986611B4AB8A0E4D6ACC25EF91D) (EEC) in Adobe Target standardmäßig TLS 1.1 verwendet. Nach dem 1. März 2020 wechselt Target standardmäßig zu TLS 1.2.
...
Wenn Sie jedoch einer der Kunden sind, die TSL 1.1 nutzen, ohne TLS 1.2 zu unterstützen, sollten Sie den Umstieg Ihrer Domänen/Infrastruktur auf TLS 1.2 planen. Wir werden das TLS 1.1-Protokoll bis März 2020 weiterhin unterstützen. Ab März 2020 unterstützt Target das TLS 1.1-Protokoll, das für VEC über die Enhanced Experience Composer-Funktion verwendet werden soll, nicht mehr.
...
* Möglicherweise müssen Sie Zielgruppen, die speziell für ältere Geräte oder Browser ohne Unterstützung für TLS 1.1 erstellt wurden, ändern, da die Bereitstellung auf solchen Geräten und Browsern nicht mehr funktioniert.
