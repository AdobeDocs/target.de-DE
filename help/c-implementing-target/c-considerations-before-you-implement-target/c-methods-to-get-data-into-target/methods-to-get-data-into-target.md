...
Informationen zu den verschiedenen Methoden, die Sie zum Abrufen von Daten in Target verwenden können, einschließlich Seitenparameter, Seitenprofilattribute, Skript-Profilattributen, Datenanbietern, die Bulk Profile Update API, die Single Profile Update API und Kundenattribute.
...
* Abfragezeichenfolgen dürfen nur Zeichen des [IETF-Standards](https://www.ietf.org/rfc/rfc3986.txt) (Internet Engineering Task Force) enthalten .
   ...
   Alle anderen Zeichen müssen URL-codiert sein. Der Standard gibt das folgende Format ( [https://www.ietf.org/rfc/rfc1738.txt](https://www.ietf.org/rfc/rfc1738.txt) ) an (siehe unten):
...
Skript-Profilattribute sind Name-Wert-Paare, die in der Target-Anwendung definiert sind. Der Wert wird aus der Ausführung eines JavaScript-Snippets auf dem Target-Server über den Server-Aufruf ermittelt.
