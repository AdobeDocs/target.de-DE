...
# Artefakt der Entscheidungsregel auf dem Gerät

Das Artefakt der Regel ist eine JSON-Darstellung Ihrer [!DNL Adobe Target]-on-device-Entscheidungs-Aktivitäten. Das Artefakt der Regel wird von [!DNL Target] erzeugt und an das Akamai-CDN weitergegeben, um sicherzustellen, dass ein Regelartefakt so nah wie möglich Ihren Besuchern zur Verfügung steht. Das Artefakt der Regel enthält Metadaten, die die genaue Ausführung und den Versand Ihrer Aktivitäten sicherstellen und gleichzeitig eine Echtzeitanalyse über die Ereignis-Verfolgung ermöglichen.

Dies ist ein Beispiel für ein Artefakt einer JSON-Regel:
