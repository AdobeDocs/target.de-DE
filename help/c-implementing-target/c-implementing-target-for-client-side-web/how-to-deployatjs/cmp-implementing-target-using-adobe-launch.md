...
description: Erfahren Sie, wie Sie die  [!DNL Adobe Target]  at.js-Bibliothek mit  [!DNL Adobe Experience Platform], the preferred method to implement [!DNL Target] implementieren.
