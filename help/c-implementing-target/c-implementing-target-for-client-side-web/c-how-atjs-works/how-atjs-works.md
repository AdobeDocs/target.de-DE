...
Weitere Informationen finden Sie unter [Javascript-Bibliotheken für Target](/help/c-intro/how-target-works.md#libraries).
...
Weitere Informationen zu den Unterschieden, die in 2. o von 1 eingeführt wurden, finden Sie unter [Aktualisieren von at. js 1. x auf at. js 2. x](/help/c-implementing-target/c-implementing-target-for-client-side-web/upgrading-from-atjs-1x-to-atjs-20.md) .*x*.
