...
| [Berichte zur automatischen Zuordnung interpretieren](/help/c-activities/automated-traffic-allocation/determine-winner.md) | Interpretieren Sie die Ergebnisse einer A/B-Aktivität mit [!UICONTROL automatisierter Zuordnung] , indem Sie wichtige Indikatoren wie Steigerung und Konfidenz in der [!DNL Target] Benutzeroberfläche untersuchen. |
