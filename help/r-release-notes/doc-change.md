...
description: Halten Sie sich mit wichtigen Ergänzungen und Änderungen an der Adobe [!DNL Target] Produktdokumentation auf dem Laufenden.
...
| 27. April | [Cookie-Einstellungen](/help/c-implementing-target/c-implementing-target-for-client-side-web/atjs-cookies.md) | Das Thema wurde aktualisiert, um anzugeben, dass die Cookie-Dauer (`deviceIdLifetime` Einstellung) in at.js-Version 2.3.1 oder höher überschrieben werden kann. |
|  | [Adobe Target-Handbuch](/help/target-home.md) | Es wurden Informationen zum Adobe Summit hinzugefügt. |
| 26. April | [Fehlerbehebung bei der geräteübergreifenden Entscheidungsfindung für at.js](/help/c-implementing-target/c-implementing-target-for-client-side-web/on-device-decisioning/troubleshooting-on-device-decisioning.md) | Neues Thema |
| 19. April | [Geräteinterne Entscheidungsfindung](/help/c-implementing-target/c-implementing-target-for-client-side-web/on-device-decisioning/on-device-decisioning.md) | Die folgenden neuen Artikel wurden hinzugefügt:<ul><li>[Geräteinterne Entscheidungsfindung](/help/c-implementing-target/c-implementing-target-for-client-side-web/on-device-decisioning/on-device-decisioning.md)</li><li>[Unterstützte Funktionen für geräteübergreifende Entscheidungen](/help/c-implementing-target/c-implementing-target-for-client-side-web/on-device-decisioning/supported-features.md)</li><li>[Artefakt der Entscheidungsregel auf dem Gerät](/help/c-implementing-target/c-implementing-target-for-client-side-web/on-device-decisioning/rule-artifact.md)</li></ul> |
...
|  | [adobe.target.getOffers() - at.js 2.x](/help/c-implementing-target/c-implementing-target-for-client-side-web/adobe-target-getoffers-atjs-2.md) | Folgendes wurde hinzugefügt:<ul><li>Informationen zum `decisioningMethod`-Schlüssel.</li><li>Ein Beispiel für &quot;getCallOffers()&quot;, um eine geräteübergreifende Entscheidung zu treffen.</li></ul> |
|  | [Benutzerdefinierte at.js-Ereignisse](/help/c-implementing-target/c-implementing-target-for-client-side-web/atjs-custom-events.md) | Folgende Informationen wurden hinzugefügt:<ul><li>Entscheidungsartefakt auf dem Gerät erfolgreich</li><li>Entscheidungsartefakt auf dem Gerät fehlgeschlagen</li></ul> |
...
|  | [Aktivitäts-QA](/help/c-activities/c-activity-qa/activity-qa.md) | Unterstützung für Vorschaulinks für [!UICONTROL Automated Personalization]-Aktivitäten mit [at.js 2.5.0](/help/c-implementing-target/c-implementing-target-for-client-side-web/target-atjs-versions.md) wurde hinzugefügt. |
|  | [Verwenden dynamischer und statischer Einschlussregeln](/help/c-recommendations/c-algorithms/use-dynamic-and-static-inclusion-rules.md#operators) | Es wurden Informationen zu den folgenden neuen Operatoren hinzugefügt:<ul><li>Ist in der Liste enthalten</li><li> ist nicht in der Liste enthalten</li><li>Liste enthält ein Element in</li><li>Liste enthält kein Element in</li><li>Liste enthält alle Elemente in</li><li>Liste enthält nicht alle Elemente in</li></ul> |
|  | [Adobe Target-Cookies](https://experienceleague.adobe.com/docs/core-services/interface/ec-cookies/cookies-target.html)<br> (*Experience Cloud Services und* Administratorhandbuch) | Es wurden zusätzliche Informationen zur &quot;Sitzungs-ID&quot;hinzugefügt. |
...
| Datum | Thema | Änderungen |
| --- | --- | --- |
| 9. April | [Target-Versionshinweise (Vorabversion)](/help/r-release-notes/target-release-notes.md) | Informationen zur Vorabversion für die at.js-Version 2.5.0 wurden hinzugefügt (19. April 2021) |
| 9. April | [Target-Versionshinweise (Vorabversion)](/help/r-release-notes/target-release-notes.md) | Informationen zur Vorabversion für die Target Standard/Premium-Version 21.4.1 wurden hinzugefügt (19. April 2021) |
...
| 29. März | [Recommendations-FAQs](/help/c-recommendations/c-recommendations-faq/recommendations-faq.md#persist-across-devices) | Neue FAQ hinzugefügt:<ul><li>Bestehen Empfehlungen, die auf kürzlich angezeigten Artikeln basieren, für einen einzelnen Besucher auf mehreren Geräten?</li></ul> |
...
|  | [Geo](/help/c-target/c-audiences/c-target-rules/geo.md) | Informationen zur at.js-Version 2 wurden hinzugefügt.** xunter &quot;Wie kann ich meine Aktivitäten als Benutzer von einem anderen Standort testen?&quot; |
|  | [Versionshinweise](/help/r-release-notes/release-notes.md): 21.2.1 | Folgender Abschnitt wurde hinzugefügt: <ul><li>IP-Adressänderungen für Recommendations-Feed-Verarbeitungsserver (16. März 2021)</li></ul> |
