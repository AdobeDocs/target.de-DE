...
**Zuletzt aktualisiert: 22. Februar 2021 ([siehe Änderungen](r-release-notes/doc-change.md))**
...
- [Zielgruppe](r-troubleshooting-target/troubleshooting-target.md) zur Fehlerbehebung: Enthält Links zur Fehlerbehebung in diesem Handbuch, einschließlich Informationen zu Zeichenbeschränkungen und anderen Einschränkungen (Angebot-Größe, Audiencen, Profil, Werte, Parameter usw.), die sich auf Aktivitäten und andere Elemente in  [!DNL Target]diesem Handbuch auswirken.
...
- [Ressourcen und Kontaktinformationen](cmp-resources-and-contact-information.md): Bietet Informationen zu weiteren Ressourcen, mit deren Hilfe Sie mehr über  [!DNL Target] Funktionen und Kontaktmöglichkeiten erfahren  [!DNL Adobe] können, falls Sie Hilfe benötigen.
...
- [Audiencen](c-target/target.md): Erläutert, wie festgestellt wird, wer Inhalte und Erlebnisse in zielgerichteten Aktivitäten sieht.
