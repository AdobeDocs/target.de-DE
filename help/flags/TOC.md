...
+ Feature Flags {#feature-flags}
  ...
  + [Berichterstellung](guides/feature-flags/reporting.md)
+ Zielgruppenkriterien {#audience}
  ...
  + [Kontextattribute erstellen](guides/audience/creating-your-context-attributes.md)
  + [Erstellen und Verwenden von Regelsätzen](guides/audience/creating-and-using-rule-sets.md)
+ Feature Flags importieren {#import}
  + [Feature Flags importieren](guides/cross-environment/import-feature-flags.md)
+ Integrationsanleitung {#sdk-releases}
  ...
  + [Handbuch zur Integration von Web-Erweiterungen](guides/sdk-releases/web/web-extension-integration-guide.md)
