...
* Sie wissen, auf welche Sandbox Sie Zugriff benötigen.

## Zugriff anfordern {#request-steps}

Wenden Sie sich an den Adobe-Support, um Zugang zu erhalten.
...
| Rolle | Beschreibung |
| --- | --- |
| **Admin** | Vollständiger Zugriff auf die Konsole. Kann Anwendungen verwalten. |
