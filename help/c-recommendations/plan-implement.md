...
Weitere Informationen zu den Unterschieden zwischen den beiden JavaScript-Bibliotheken in Target finden Sie unter [Grundlegendes zu den JavaScript-Bibliotheken in Target](../c-implementing-target/c-considerations-before-you-implement-target/target-implement.md#concept_60B748DE4293488F917E8F1FA4C7E9EB).
...
Um auf die [!UICONTROL Empfehlungs-Einstellungen] zuzugreifen, öffnen Sie [!DNL Target] in [!DNL Adobe Experience Cloud] und klicken Sie dann auf **[!UICONTROL Empfehlungen]** &gt; **[!UICONTROL Einstellungen]**.
