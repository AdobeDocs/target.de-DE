...
Bevor Sie mit der Verwendung beginnen, [!DNL Recommendations]sollten Sie sich mit einigen der in diesem Abschnitt verwendeten Begriffe vertraut machen. Machen Sie sich keine Gedanken, wenn Sie diese Begriffe noch nicht vollständig verstehen, werden Sie sich bei der Einrichtung Ihrer [!DNL Recommendations] Aktivitäten mit ihnen vertraut machen.
...
| Entwürfe | Entwürfe definieren das Erscheinungsbild der Empfehlungen in einer [!DNL Recommendations] Aktivität, wie z. B. eine Zeile, Spalte, Tabelle oder ein Raster. Die Abbildung oben in diesem Artikel zeigt ein 4 x 1-Design. For more information, see [Create a design](/help/c-recommendations/c-design-overview/create-design.md). |
...
## Schulungsvideo: Aktivität Typen - ![Übersicht](/help/assets/overview.png)
