...
description: Erfahren Sie, wie Sie das Bedienfeld "Änderungen"in Adobe [!DNL Target] verwenden, um Seitenänderungen anzuzeigen und zusätzliche Änderungen hinzuzufügen (CSS-Selektor, Mbox und benutzerspezifischer Code).
...
Informationen zur Seite &quot;Änderungen&quot;in [!DNL Adobe Target], über die Sie Änderungen an Ihrer Seite anzeigen und zusätzliche Änderungen hinzufügen können (CSS-Selektor, Mbox und benutzerspezifischer Code).
