...
Unter bestimmten Umständen treten im [!DNL Adobe Target] Visual Experience Composer (VEC) und im Enhanced Experience Composer (EEC) manchmal Anzeigeprobleme und andere Probleme auf.

## Wie wirken sich die kürzlich angekündigten Richtlinien zur Durchsetzung von SameSite-Cookies in Google Chrome auf VEC und EEC aus? {#samesite}

Mit den neuesten Änderungen (August 2020) können alle Benutzer mit Chrome 80+-Browserversionen:

* Kann *not* VEC (mit oder ohne installierte und aktivierte VEC Helper-Erweiterung) auf kennwortgeschützten Seiten ihrer Sites verwenden. Der Grund dafür ist, dass ihre Site-Anmelde-Cookies als Drittanbieter-Cookie betrachtet werden und nicht mit der Anmeldeanfrage gesendet werden. Die einzige Ausnahme besteht darin, dass der SameSite-Parameter für das Anmelde-Cookie der Kundensite bereits auf &quot;none&quot;gesetzt ist.
...
* Verwenden Sie weiterhin Chrome, aber setzen Sie das `chrome://flags/#same-site-by-default-cookies`-Flag auf &quot;Deaktiviert&quot;.
   ...
   >[!NOTE]
   >
   >Dies ist *nicht* ausreichend, wenn für Cookies vom Server bereits das SameSite-Attribut auf &quot;Lax&quot;oder &quot;Strict&quot;gesetzt ist.
