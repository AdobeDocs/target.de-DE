...
# Fehlerbehebung bei Problemen mit dem [!UICONTROL Enhanced Experience Composer]
...
Dies kann durch Zulassungsauflistung der folgenden IP-Adressen behoben werden. Diese IP-Adressen werden für den Server der Adobe verwendet, der für den EWG-Proxy verwendet wird. Sie werden nur für die Bearbeitung der Aktivitäten benötigt. Besucher Ihrer Site benötigen diese IP-Adressen nicht auf die Zulassungsliste gesetzt.
...
Folgende Fehlermeldung wird möglicherweise in [!DNL Target] angezeigt:
...
* **Problem:** Die IP-Adressen werden auf die Zulassungsliste gesetzt, aber Ihre Website unterstützt keine TLS Version 1.2.  [!DNL Target] verwendet derzeit die Standardkonfiguration von 1.2. Vor dem  [!DNL Target] 18.4.1 (25. April 2018) wurde TLS 1.0 von der Standardkonfiguration unterstützt. Weitere Informationen finden Sie unter Änderungen bei der Verschlüsselung von  [TLS (Transport Layer Security)](/help/c-implementing-target/c-considerations-before-you-implement-target/tls-transport-layer-security-encryption.md#concept_CC1001E9D3AE4BABAF90B8311B0A6451).
...
Möglicherweise sehen Sie die Fehlermeldung, die oben unter &quot;Der [!UICONTROL Enhanced Visual Experience Composer] wird nicht auf sicheren Seiten auf meiner Site geladen&quot; beschrieben ist. wenn die oben genannten IP-Adressen auf die Zulassungsliste gesetzt werden, Ihre Website jedoch keine TLS-Version 1.2 unterstützt. [!DNL Target] verwendet derzeit die Standardkonfiguration von 1.2. Vor der Version [!DNL Target] 18.4.1 (25. April 2018) wurde TLS 1.0 von der Standardkonfiguration unterstützt. Weitere Informationen finden Sie unter [TLS (Transport Layer Security) Encryption Changes](/help/c-implementing-target/c-considerations-before-you-implement-target/tls-transport-layer-security-encryption.md#concept_CC1001E9D3AE4BABAF90B8311B0A6451).
